...
void __fastcall TForm1::UpdatenowClick(TObject *Sender)
{
        ...
        NeListBox->Items->Add("BAKBSC1_X29,PROT=V24 1");
        NeListBox->Items->Add("BSC3 3");
        NeListBox->Items->Add("GENBSC4_X29,PROT=V24 4");
        NeListBox->Items->Add("GNBSC4B_X29,PROT=V24 4B");
...
DeleteFile("c:\\Report.xls");
XL.OlePropertyGet("Workbooks").OlePropertyGet("Item",1).OleProcedure("SaveAs","c:\\Report.xls");
...
ReportMemo->Lines->Add("Export finished.(c:\\Export.xls)");
}
//---------------------------------------------------------------------------
