...
{
if(edge==true)
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&&"+(dcp+8)+";");
else
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",ANT="+Form2->Antc1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc1->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk1->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
{
if(edge==true)
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&&"+(dcp+8)+";");
else
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",ANT="+Form2->Antc1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc1->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk2->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
{
if(edge==true)
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&&"+(dcp+8)+";");
else
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",ANT="+Form2->Antc1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc1->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk3->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
 ...
 {
if(edge==true)
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&&"+(dcp+8)+";");
else
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell1->Text+",ANT="+Form2->Antc1->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc1->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk4->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",ANT="+Form2->Antc2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc2->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk1->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",ANT="+Form2->Antc2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc2->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk2->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",ANT="+Form2->Antc2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc2->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk3->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell2->Text+",ANT="+Form2->Antc2->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc2->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk4->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",ANT="+Form2->Antc3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc3->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk1->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",ANT="+Form2->Antc3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc3->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk2->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",ANT="+Form2->Antc3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc3->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk3->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell3->Text+",ANT="+Form2->Antc3->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc3->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk4->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk1->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",ANT="+Form2->Antc4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk1->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc4->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk1->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk2->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",ANT="+Form2->Antc4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk2->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc4->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk2->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk3->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",ANT="+Form2->Antc4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk3->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc4->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk3->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
Form2->List->Items->Add("RXMOI:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",TEI="+tru+",DCP1="+dcp+",DCP2="+(dcp+1)+"&"+(dcp+2)+";");
Form2->List->Items->Add("RXMOC:MO=RXOTRX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",MPWR="+Form2->Mpwr->Text+";");
Form2->List->Items->Add("RXMOC:MO=RXOTX-"+Form3->Tgk4->Text+"-"+tru+",CELL="+Form2->Cell4->Text+",ANT="+Form2->Antc4->Text+",CHGR="+chgr+";");
Form2->List->Items->Add("RXMOI:MO=RXORX-"+Form3->Tgk4->Text+"-"+tru+",BAND="+Form2->Band->Text+",RXD="+Form2->Rxdc4->Text+",ANTA=YES,ANTB=YES;");
Form2->List->Items->Add("RXMOI:MO=RXOTS-"+Form3->Tgk4->Text+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
 }
...
{
Form2->List->Items->Add("RXESI:MO=RXOTG-"+TG+";");
Form2->List->Items->Add("RXBLE:MO=RXOTG-"+TG+";");
Form2->List->Items->Add("RXESI:MO=RXOCF-"+TG+";");
Form2->List->Items->Add("RXBLE:MO=RXOCF-"+TG+";");
Form2->List->Items->Add("RXESI:MO=RXODP-"+TG+"-0;");
Form2->List->Items->Add("RXBLE:MO=RXODP-"+TG+"-0;");
Form2->List->Items->Add("RXESI:MO=RXOIS-"+TG+";");
Form2->List->Items->Add("RXBLE:MO=RXOIS-"+TG+";");
Form2->List->Items->Add("RXESI:MO=RXOTF-"+TG+";");
Form2->List->Items->Add("RXBLE:MO=RXOTF-"+TG+";");
Form2->List->Items->Add("");
return(0);
}
...
{
Form2->List->Items->Add("RXESI:MO=RXOTRX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXBLE:MO=RXOTRX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXESI:MO=RXOTX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXBLE:MO=RXOTX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXESI:MO=RXORX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXBLE:MO=RXORX-"+TG+"-"+tru+";");
Form2->List->Items->Add("RXESI:MO=RXOTS-"+TG+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("RXBLE:MO=RXOTS-"+TG+"-"+tru+"-0&&-7;");
Form2->List->Items->Add("");
return(0);
}
...
Form2->List->Items->Add("RXAPI:MO=RXOTG-"+IntToStr(TG)+",DCP="+IntToStr(Dcp1)+"&&"+IntToStr(Dcp2)+",DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+",RES64k;");
Form2->List->Items->Add("EXDAI:DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("BLODE:DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("");}
else{
Form2->List->Items->Add("RXAPI:MO=RXOTG-"+IntToStr(TG)+",DCP="+IntToStr(Dcp1)+"&&"+IntToStr(Dcp2)+",DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+",RES64k;");
Form2->List->Items->Add("EXDAI:DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("BLODE:DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("");}
goto son;
}
...
if(Form2->Bscc1->Text=="1" || Form2->Bscc1->Text=="5"){
Form2->List->Items->Add("RXAPI:MO=RXOTG-"+IntToStr(TG)+",DCP="+IntToStr(Dcp1)+"&&"+IntToStr(Dcp2)+",DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("EXDAI:DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("BLODE:DEV=RBLT-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("");
}
else{
Form2->List->Items->Add("RXAPI:MO=RXOTG-"+IntToStr(TG)+",DCP="+IntToStr(Dcp1)+"&&"+IntToStr(Dcp2)+",DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("EXDAI:DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("BLODE:DEV=RBLT2-"+IntToStr(Dip*32+Ddcp1)+"&&-"+IntToStr(Dip*32+Ddcp2)+";");
Form2->List->Items->Add("");}
...
//--------------------------------------------------------------------------
String Intqon(String Cell,String Bcchc,String Cellr,String Bcchcr,String Cs){
Form2->List->Items->Add("RLNRI:CELL="+Cell+",CELLR="+Cellr+";");
Form2->List->Items->Add("RLMFC:CELL="+Cell+",MBCCHNO="+Bcchcr+",MRNIC;");
Form2->List->Items->Add("RLMFC:CELL="+Cellr+",MBCCHNO="+Bcchc+",MRNIC;");
Form2->List->Items->Add("RLNRC:CELL="+Cell+",CELLR="+Cellr+",KHYST="+Form2->Khyst->Text+",LHYST="+Form2->Lhyst->Text+",TRHYST="+Form2->Trhyst->Text+",CAND="+Form2->Cand->Text+",AWOFFSET="+Form2->Awoffset->Text+",CS="+Cs+";");
if(Form2->Hihyst->Text!="")
Form2->List->Items->Add("RLNRC:CELL="+Cell+",CELLR="+Cellr+",HIHYST="+Form2->Hihyst->Text+";");
Form2->List->Items->Add("RLSSC:CELL="+Cellr+",MBCR="+Form2->Mbcr->Text+";");
Form2->List->Items->Add("");
...
if (PageControl1->ActivePageIndex==PageControl1->PageCount-1)
  ...
  if(List->Checked[i])
  Form1->Memo1->Lines->Add(List->Items->Strings[i]);

  Form1->Show();
  Form2->Close();
  }
else if (PageControl1->ActivePageIndex==PageControl1->PageCount-2)
  {
  List->Clear();
  Form2->CheckpnlClick(Checkpnl);
    ...
    Form2->FinishcheckpnlClick(Finishcheckpnl);
    Test="";

    Button2->Caption="Accept";
    PageControl1->SelectNextPage(true,true);
    }
  }
else if(PageControl1->ActivePageIndex<PageControl1->PageCount)
PageControl1->SelectNextPage(true,true);
...
Form3->Bufferf3->Lines->Add("");
 ...
 if(Form2->Cspsallocc1->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Cspsallocc1");
Form3->Bufferf3->Lines->Add(Form2->Cspsallocc1->Text);
Form3->Bufferf3->Lines->Add("");
}
...
if(Form2->Lsstate->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Lsstate");
Form3->Bufferf3->Lines->Add(Form2->Lsstate->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Clsstate->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Clsstate");
Form3->Bufferf3->Lines->Add(Form2->Clsstate->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Clslevel->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Clslevel");
Form3->Bufferf3->Lines->Add(Form2->Clslevel->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Clsacc->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Clsacc");
Form3->Bufferf3->Lines->Add(Form2->Clsacc->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Hoclsacc->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Hoclsacc");
Form3->Bufferf3->Lines->Add(Form2->Hoclsacc->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Clsramp->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Clsramp");
Form3->Bufferf3->Lines->Add(Form2->Clsramp->Text);
Form3->Bufferf3->Lines->Add("");
}

if(Form2->Rhyst->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Rhyst");
Form3->Bufferf3->Lines->Add(Form2->Rhyst->Text);
Form3->Bufferf3->Lines->Add("");
}
...
Form3->Bufferf3->Lines->Add("");
 ...
 if(Form2->Cspsallocc2->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Cspsallocc2");
Form3->Bufferf3->Lines->Add(Form2->Cspsallocc2->Text);
Form3->Bufferf3->Lines->Add("");
}
...
Form3->Bufferf3->Lines->Add("");
 ...
 if(Form2->Cspsallocc3->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Cspsallocc3");
Form3->Bufferf3->Lines->Add(Form2->Cspsallocc3->Text);
Form3->Bufferf3->Lines->Add("");
}
...
Form3->Bufferf3->Lines->Add("");
 ...
 if(Form2->Cspsallocc4->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Cspsallocc4");
Form3->Bufferf3->Lines->Add(Form2->Cspsallocc4->Text);
Form3->Bufferf3->Lines->Add("");
}
...
if(Form2->Crhc1->GetTextLen()!=0)
{
Form3->Bufferf3->Lines->Add("Crhc1");
Form3->Bufferf3->Lines->Add(Form2->Crhc1->Text);
Form3->Bufferf3->Lines->Add("");
}
...
for (int u = 0; u< Form3->Bufferf3->Lines->Count; u++)
 ...
 //----------------------- Cell1-ucun------------------------------//
    ...
    if (int Cspsallocc1= Form3->Bufferf3->Lines->Strings[u].Pos("Cspsallocc1"))
    Form2->Cspsallocc1->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Chapc1= Form3->Bufferf3->Lines->Strings[u].Pos("Chapc1"))
    Form2->Chapc1->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Lsstate= Form3->Bufferf3->Lines->Strings[u].Pos("Lsstate"))
    Form2->Lsstate->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Clsstate= Form3->Bufferf3->Lines->Strings[u].Pos("Clsstate"))
    Form2->Clsstate->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Clslevel= Form3->Bufferf3->Lines->Strings[u].Pos("Clslevel"))
    Form2->Clslevel->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Clsacc= Form3->Bufferf3->Lines->Strings[u].Pos("Clsacc"))
    Form2->Clsacc->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Hoclsacc= Form3->Bufferf3->Lines->Strings[u].Pos("Hoclsacc"))
    Form2->Hoclsacc->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Clsramp= Form3->Bufferf3->Lines->Strings[u].Pos("Clsramp"))
    Form2->Clsramp->Text=Form3->Bufferf3->Lines->Strings[u+1];

    if (int Rhyst= Form3->Bufferf3->Lines->Strings[u].Pos("Rhyst"))
    Form2->Rhyst->Text=Form3->Bufferf3->Lines->Strings[u+1];
    ...
    if (int Cspsallocc2= Form3->Bufferf3->Lines->Strings[u].Pos("Cspsallocc2"))
    Form2->Cspsallocc2->Text=Form3->Bufferf3->Lines->Strings[u+1];
    ...
    if (int Cspsallocc3= Form3->Bufferf3->Lines->Strings[u].Pos("Cspsallocc3"))
    Form2->Cspsallocc3->Text=Form3->Bufferf3->Lines->Strings[u+1];
    ...
    if (int Cspsallocc4= Form3->Bufferf3->Lines->Strings[u].Pos("Cspsallocc4"))
    Form2->Cspsallocc4->Text=Form3->Bufferf3->Lines->Strings[u+1];
 ...
 //------------------------------Standart for all Cells-------------------------//
    ...
    Form2->Nccperm->Text=Form3->Bufferf3->Lines->Strings[u+1];
     ...
     if (int Crhc1= Form3->Bufferf3->Lines->Strings[u].Pos("Crhc1"))
    Form2->Crhc1->Text=Form3->Bufferf3->Lines->Strings[u+1];
...
void __fastcall TForm2::Challocc1Change(TObject *Sender)
{
 ...
 if(Tabc2->TabVisible==true)
 Cspsallocc2->ItemIndex=Cspsallocc1->ItemIndex;

 if(Tabc3->TabVisible==true)
  Cspsallocc3->ItemIndex=Cspsallocc1->ItemIndex;

  if(Tabc4->TabVisible==true)
 Cspsallocc4->ItemIndex=Cspsallocc1->ItemIndex;
}
//---------------------------------------------------------------------------
...
{
List->Items->Add("@L \\\\azercell\\FILES\\ICT\\CNO\\OMC\\BSC\\LOG_yeni_site\\"+FormatDateTime("yyyy",Now())+"\\BSC"+Bscc1->Text+"_"+Rsitec1->Text+".log");
List->Items->Add("@COMMENT                      "+Rsitec1->Text);
List->Items->Add("");
List->Items->Add("@COMMENT ----------------------------------------------------------------------");
if(Form3->Tgsayi->ItemIndex==0)
List->Items->Add("@COMMENT      TG              "+Form3->Tg1->Text);
if(Form3->Tgsayi->ItemIndex==1)
List->Items->Add("@COMMENT      TG              "+Form3->Tg1->Text+","+Form3->Tg2->Text);
if(Form3->Tgsayi->ItemIndex==2)
List->Items->Add("@COMMENT      TG              "+Form3->Tg1->Text+","+Form3->Tg2->Text+","+Form3->Tg3->Text);
if(Form3->Tgsayi->ItemIndex==3)
List->Items->Add("@COMMENT      TG              "+Form3->Tg1->Text+","+Form3->Tg2->Text+","+Form3->Tg3->Text+","+Form3->Tg4->Text);

if(Form3->Rbltsayi->ItemIndex==0)
List->Items->Add("@COMMENT      RBLT            "+Form3->Rblt1->Text);
if(Form3->Rbltsayi->ItemIndex==1)
List->Items->Add("@COMMENT      Rblt            "+Form3->Rblt1->Text+","+Form3->Rblt2->Text);
if(Form3->Rbltsayi->ItemIndex==2)
List->Items->Add("@COMMENT      Rblt            "+Form3->Rblt1->Text+","+Form3->Rblt2->Text+","+Form3->Rblt3->Text);
if(Form3->Rbltsayi->ItemIndex==3)
List->Items->Add("@COMMENT      Rblt            "+Form3->Rblt1->Text+","+Form3->Rblt2->Text+","+Form3->Rblt3->Text+","+Form3->Rblt4->Text);

List->Items->Add("@COMMENT      SITENO          "+Form3->Siteno->Text);
List->Items->Add("@COMMENT      TYPE            "+Form3->Tpk1->Text);
List->Items->Add("@COMMENT ----------------------------------------------------------------------");
List->Items->Add("");
}
//---------------------------------------------------------------------------
...
List->Items->Add("@COMMENT "+Cell1->Text+" CELL DEFINITION");
List->Items->Add("RLDEI:CELL="+Cell1->Text+",CSYSTYPE="+Form3->Csystype->Text+";");
List->Items->Add("RLDEC:CELL="+Cell1->Text+",CGI="+Cgic1->Text+",BSIC="+Bsicc1->Text+",BCCHNO="+Bcchnoc1->Text+",MFRMS="+Mfrms->Text+",BCCHTYPE="+Bcchtype->Text+",AGBLK="+Agblk->Text+",FNOFFSET="+Fnoffset->Text+",IRC="+Irc->Text+";");
List->Items->Add("RLDHC:CELL="+Cell1->Text+",DHA="+Dha->Text+",DTHNAMR="+Dthnamr->Text+";");
if(Form3->Fhop->ItemIndex==0)
if(Tchch0c1->Text!="")
List->Items->Add("RLCFI:CELL="+Cell1->Text+",DCHNO="+Tchch0c1->Text+",CHGR=0;");
List->Items->Add("RLCCC:CELL="+Cell1->Text+",CHGR=0,SDCCH="+Sdcchchgr0c1->Text+",CBCH=YES,TN="+Tnchgr0c1->Text+";");
if(Addch1c1->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell1->Text+",CHGR=1;");
List->Items->Add("RLCFI:CELL="+Cell1->Text+",DCHNO="+Tchch1c1->Text+",CHGR=1;");
List->Items->Add("RLCCC:CELL="+Cell1->Text+",CHGR=1,SDCCH="+Sdcchchgr1c1->Text+",CBCH=NO,TN="+Tnchgr1c1->Text+";");
}
if(Addch2c1->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell1->Text+",CHGR=2;");
List->Items->Add("RLCFI:CELL="+Cell1->Text+",DCHNO="+Tchch2c1->Text+",CHGR=2;");
List->Items->Add("RLCCC:CELL="+Cell1->Text+",CHGR=2,SDCCH="+Sdcchchgr2c1->Text+",CBCH=NO,TN="+Tnchgr2c1->Text+";");
}
if(Addch3c1->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell1->Text+",CHGR=3;");
List->Items->Add("RLCFI:CELL="+Cell1->Text+",DCHNO="+Tchch3c1->Text+",CHGR=3;");
List->Items->Add("RLCCC:CELL="+Cell1->Text+",CHGR=3,SDCCH="+Sdcchchgr3c1->Text+",CBCH=NO,TN="+Tnchgr3c1->Text+";");
}

List->Items->Add("RLCPC:CELL="+Cell1->Text+",BSPWRT="+Bspwrtc1->Text+",BSPWRB="+Bspwrbc1->Text+",MSTXPWR="+Mstxpwr->Text+";");
List->Items->Add("RLCXC:CELL="+Cell1->Text+",DTXD="+Dtxd->Text+";");
List->Items->Add("RLLOC:CELL="+Cell1->Text+",BSPWR="+Bspwrc1->Text+",BSTXPWR="+Bstxpwrc1->Text+",BSRXMIN="+Bsrxminc1->Text+",BSRXSUFF="+Bsrxsuffc1->Text+",MSRXMIN="+Msrxminc1->Text+",MSRXSUFF="+Msrxsuff->Text+";");
List->Items->Add("RLLOC:CELL="+Cell1->Text+",SCHO="+Scho->Text+",MISSNM="+Missnm->Text+",AW="+Awc1->Text+";");
List->Items->Add("RLLUC:CELL="+Cell1->Text+",QLIMUL="+Qlimul->Text+",QLIMDL="+Qlimdl->Text+",TALIM="+Talimc1->Text+",CELLQ="+Cellq->Text+";");
List->Items->Add("RLLUC:CELL="+Cell1->Text+",QLIMULAFR="+Qlimulafr->Text+",QLIMDLAFR="+Qlimdlafr->Text+";");
List->Items->Add("RLLPC:CELL="+Cell1->Text+",PTIMHF="+Ptimhf->Text+",PTIMBQ="+Ptimbq->Text+",PTIMTA="+Ptimta->Text+",PSSHF="+Psshf->Text+",PSSBQ="+Pssbq->Text+",PSSTA="+Pssta->Text+";");
List->Items->Add("RLLFC:CELL="+Cell1->Text+",SSEVALSD="+Ssevalsd->Text+",QEVALSD="+Qevalsd->Text+",SSEVALSI="+Ssevalsi->Text+",QEVALSI="+Qevalsi->Text+";");
List->Items->Add("RLLFC:CELL="+Cell1->Text+",SSLENSD="+Sslensd->Text+",QLENSD="+Qlensd->Text+",SSLENSI="+Sslensi->Text+",QLENSI="+Qlensi->Text+",SSRAMPSD="+Ssrampsd->Text+",SSRAMPSI="+Ssrampsi->Text+";");
List->Items->Add("RLLDC:CELL="+Cell1->Text+",MAXTA="+Maxta->Text+",RLINKUP="+Rlinkup->Text+",RLINKUPAFR="+Rlinkupafr->Text+",RLINKUPAHR="+Rlinkupahr->Text+";");
List->Items->Add("RLLCI:CELL="+Cell1->Text+";");
List->Items->Add("RLLCC:CELL="+Cell1->Text+",CLSLEVEL="+Clslevel->Text+",CLSACC="+Clsacc->Text+",HOCLSACC="+Hoclsacc->Text+",RHYST="+Rhyst->Text+",CLSRAMP="+Clsramp->Text+";");
List->Items->Add("RLSSC:CELL="+Cell1->Text+",ACCMIN="+Accmin->Text+",CCHPWR="+Cchpwr->Text+",CRH="+Crhc1->Text+",DTXU="+Dtxu->Text+",NCCPERM="+Nccperm->Text+",RLINKT="+Rlinkt->Text+",RLINKTAFR="+Rlinktafr->Text+",RLINKTAHR="+Rlinktahr->Text+";");
List->Items->Add("RLHPC:CELL="+Cell1->Text+",CHAP="+Chapc1->Text+";");
List->Items->Add("RLCLC:CELL="+Cell1->Text+",CSPSALLOC="+Cspsallocc1->Text+";");
List->Items->Add("RLSBC:CELL="+Cell1->Text+",CB="+Cb->Text+",ACC="+Acc->Text+",MAXRET="+Maxret->Text+",TX="+Tx->Text+",ATT="+Att->Text+",T3212="+T3212->Text+",ECSC="+Ecsc->Text+";");
List->Items->Add("RLSBC:CELL="+Cell1->Text+",CBQ="+Cbq->Text+",CRO="+Cro->Text+",TO="+To->Text+",PT="+Pt->Text+";");
List->Items->Add("RLIHC:CELL="+Cell1->Text+",IHO="+Iho->Text+",MAXIHO="+Maxiho->Text+",TMAXIHO="+Tmaxiho->Text+",TIHO="+Tiho->Text+";");
List->Items->Add("RLIHC:CELL="+Cell1->Text+",SSOFFSETULP="+Ssoffsetulp->Text+",QOFFSETULP="+Qoffsetulp->Text+",SSOFFSETDLP="+Ssoffsetdlp->Text+",QOFFSETDLP="+Qoffsetdlp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell1->Text+",SSOFFSETULN="+Ssoffsetuln->Text+",QOFFSETULN="+Qoffsetuln->Text+",SSOFFSETDLN="+Ssoffsetdln->Text+",QOFFSETDLN="+Qoffsetdln->Text+";");
List->Items->Add("RLIHC:CELL="+Cell1->Text+",SSOFFSETULAFRP="+Ssoffsetulafrp->Text+",QOFFSETULAFRP="+Qoffsetulafrp->Text+",SSOFFSETDLAFRP="+Ssoffsetdlafrp->Text+",QOFFSETDLAFRP="+Qoffsetdlafrp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell1->Text+",SSOFFSETULAFRN="+Ssoffsetulafrn->Text+",QOFFSETULAFRN="+Qoffsetulafrn->Text+",SSOFFSETDLAFRN="+Ssoffsetdlafrn->Text+",QOFFSETDLAFRN="+Qoffsetdlafrn->Text+";");
List->Items->Add("RLLHC:CELL="+Cell1->Text+",LAYER="+Levelc1->Text+",LAYERTHR="+Levthrc1->Text+",LAYERHYST="+Layerhystc1->Text+",PSSTEMP="+Psstemp->Text+",PTIMTEMP="+Ptimtemp->Text+";");
if(Dmpstate->Text=="ACTIVE")
List->Items->Add("RLPCI:CELL="+Cell1->Text+";");
List->Items->Add("RLPCC:CELL="+Cell1->Text+",SSDESUL="+Ssdesul->Text+",LCOMPUL="+Lcompul->Text+",QDESUL="+Qdesul->Text+",QCOMPUL="+Qcompul->Text+";");
if(Dbpstate->Text=="ACTIVE")
List->Items->Add("RLBCI:CELL="+Cell1->Text+";");
List->Items->Add("RLBCC:CELL="+Cell1->Text+",SSDESDL="+Ssdesdl->Text+",LCOMPDL="+Lcompdl->Text+",QDESDL="+Qdesdl->Text+",QCOMPDL="+Qcompdl->Text+";");
List->Items->Add("RLCDC:CELL="+Cell1->Text+",MC="+Mc->Text+";");
List->Items->Add("RLGSI:CELL="+Cell1->Text+";");
List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch0c1->Text+",CHGR=0;");
if(Form3->Fhop->ItemIndex==1)
{
List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch1c1->Text+",CHGR=1,MAIO="+Maioch1c1->Text+",HSN="+Hsnch1c1->Text+";");
 if(Addch2c1->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch2c1->Text+",CHGR=2,MAIO="+Maioch2c1->Text+",HSN="+Hsnch2c1->Text+";");
 if(Addch3c1->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch3c1->Text+",CHGR=3,MAIO="+Maioch3c1->Text+",HSN="+Hsnch3c1->Text+";");
}
else
{
if(Addch1c1->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch1c1->Text+",CHGR=1;");
if(Addch2c1->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch2c1->Text+",CHGR=2;");
if(Addch3c1->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell1->Text+",HOP="+Hopch3c1->Text+",CHGR=3;");
}
if(Amrpcstate->Text=="ACTIVE")
List->Items->Add("RLAPI:CELL="+Cell1->Text+";");
List->Items->Add("RLAPC:CELL="+Cell1->Text+",SSDESDLAFR="+Ssdesdlafr->Text+",QDESDLAFR="+Qdesdlafr->Text+",SSDESULAFR="+Ssdesulafr->Text+",QDESULAFR="+Qdesulafr->Text+";");
List->Items->Add("RLAPC:CELL="+Cell1->Text+",SSDESDLAHR="+Ssdesdlahr->Text+",QDESDLAHR="+Qdesdlahr->Text+",SSDESULAHR="+Ssdesulahr->Text+",QDESULAHR="+Qdesulahr->Text+";");
List->Items->Add("RLGAC:CELL="+Cell1->Text+",CHGR=0,SAS="+Sas->Text+";");
if(Addch1c1->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell1->Text+",CHGR=1,SAS="+Sas->Text+";");
if(Addch2c1->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell1->Text+",CHGR=2,SAS="+Sas->Text+";");
if(Addch3c1->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell1->Text+",CHGR=3,SAS="+Sas->Text+";");
List->Items->Add("RLGSC:CELL="+Cell1->Text+",FPDCH="+Fpdch->Text+",GAMMA="+Gamma->Text+",LA="+La->Text+";");
List->Items->Add("RLDUI:CELL="+Cell1->Text+";");
List->Items->Add("RLDMI:CELL="+Cell1->Text+";");
List->Items->Add("RLDMC:CELL="+Cell1->Text+",DMQB="+Dmqb->Text+",DMQG="+Dmqg->Text+";");
List->Items->Add("");
...
if(Tabc2->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell2->Text+" CELL DEFINITION");
List->Items->Add("RLDEI:CELL="+Cell2->Text+",CSYSTYPE="+Form3->Csystype->Text+";");
List->Items->Add("RLDEC:CELL="+Cell2->Text+",CGI="+Cgic2->Text+",BSIC="+Bsicc2->Text+",BCCHNO="+Bcchnoc2->Text+",MFRMS="+Mfrms->Text+",BCCHTYPE="+Bcchtype->Text+",AGBLK="+Agblk->Text+",FNOFFSET="+Fnoffset->Text+",IRC="+Irc->Text+";");
List->Items->Add("RLDHC:CELL="+Cell2->Text+",DHA="+Dha->Text+",DTHNAMR="+Dthnamr->Text+";");
if(Form3->Fhop->ItemIndex==0)
if(Tchch0c2->Text!="")
List->Items->Add("RLCFI:CELL="+Cell2->Text+",DCHNO="+Tchch0c2->Text+",CHGR=0;");
List->Items->Add("RLCCC:CELL="+Cell2->Text+",CHGR=0,SDCCH="+Sdcchchgr0c2->Text+",CBCH=YES,TN="+Tnchgr0c2->Text+";");
if(Addch1c2->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell2->Text+",CHGR=1;");
List->Items->Add("RLCFI:CELL="+Cell2->Text+",DCHNO="+Tchch1c2->Text+",CHGR=1;");
List->Items->Add("RLCCC:CELL="+Cell2->Text+",CHGR=1,SDCCH="+Sdcchchgr1c2->Text+",CBCH=NO,TN="+Tnchgr1c2->Text+";");
}
if(Addch2c2->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell2->Text+",CHGR=2;");
List->Items->Add("RLCFI:CELL="+Cell2->Text+",DCHNO="+Tchch2c2->Text+",CHGR=2;");
List->Items->Add("RLCCC:CELL="+Cell2->Text+",CHGR=2,SDCCH="+Sdcchchgr2c2->Text+",CBCH=NO,TN="+Tnchgr2c2->Text+";");
}
if(Addch3c2->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell2->Text+",CHGR=3;");
List->Items->Add("RLCFI:CELL="+Cell2->Text+",DCHNO="+Tchch3c2->Text+",CHGR=3;");
List->Items->Add("RLCCC:CELL="+Cell2->Text+",CHGR=3,SDCCH="+Sdcchchgr3c2->Text+",CBCH=NO,TN="+Tnchgr3c2->Text+";");
}

List->Items->Add("RLCPC:CELL="+Cell2->Text+",BSPWRT="+Bspwrtc2->Text+",BSPWRB="+Bspwrbc2->Text+",MSTXPWR="+Mstxpwr->Text+";");
List->Items->Add("RLCXC:CELL="+Cell2->Text+",DTXD="+Dtxd->Text+";");
List->Items->Add("RLLOC:CELL="+Cell2->Text+",BSPWR="+Bspwrc2->Text+",BSTXPWR="+Bstxpwrc2->Text+",BSRXMIN="+Bsrxminc2->Text+",BSRXSUFF="+Bsrxsuffc2->Text+",MSRXMIN="+Msrxminc2->Text+",MSRXSUFF="+Msrxsuff->Text+";");
List->Items->Add("RLLOC:CELL="+Cell2->Text+",SCHO="+Scho->Text+",MISSNM="+Missnm->Text+",AW="+Awc2->Text+";");
List->Items->Add("RLLUC:CELL="+Cell2->Text+",QLIMUL="+Qlimul->Text+",QLIMDL="+Qlimdl->Text+",TALIM="+Talimc2->Text+",CELLQ="+Cellq->Text+";");
List->Items->Add("RLLUC:CELL="+Cell2->Text+",QLIMULAFR="+Qlimulafr->Text+",QLIMDLAFR="+Qlimdlafr->Text+";");
List->Items->Add("RLLPC:CELL="+Cell2->Text+",PTIMHF="+Ptimhf->Text+",PTIMBQ="+Ptimbq->Text+",PTIMTA="+Ptimta->Text+",PSSHF="+Psshf->Text+",PSSBQ="+Pssbq->Text+",PSSTA="+Pssta->Text+";");
List->Items->Add("RLLFC:CELL="+Cell2->Text+",SSEVALSD="+Ssevalsd->Text+",QEVALSD="+Qevalsd->Text+",SSEVALSI="+Ssevalsi->Text+",QEVALSI="+Qevalsi->Text+";");
List->Items->Add("RLLFC:CELL="+Cell2->Text+",SSLENSD="+Sslensd->Text+",QLENSD="+Qlensd->Text+",SSLENSI="+Sslensi->Text+",QLENSI="+Qlensi->Text+",SSRAMPSD="+Ssrampsd->Text+",SSRAMPSI="+Ssrampsi->Text+";");
List->Items->Add("RLLDC:CELL="+Cell2->Text+",MAXTA="+Maxta->Text+",RLINKUP="+Rlinkup->Text+",RLINKUPAFR="+Rlinkupafr->Text+",RLINKUPAHR="+Rlinkupahr->Text+";");
List->Items->Add("RLLCI:CELL="+Cell2->Text+";");
List->Items->Add("RLLCC:CELL="+Cell2->Text+",CLSLEVEL="+Clslevel->Text+",CLSACC="+Clsacc->Text+",HOCLSACC="+Hoclsacc->Text+",RHYST="+Rhyst->Text+",CLSRAMP="+Clsramp->Text+";");
List->Items->Add("RLSSC:CELL="+Cell2->Text+",ACCMIN="+Accmin->Text+",CCHPWR="+Cchpwr->Text+",CRH="+Crhc2->Text+",DTXU="+Dtxu->Text+",NCCPERM="+Nccperm->Text+",RLINKT="+Rlinkt->Text+",RLINKTAFR="+Rlinktafr->Text+",RLINKTAHR="+Rlinktahr->Text+";");
List->Items->Add("RLHPC:CELL="+Cell2->Text+",CHAP="+Chapc2->Text+";");
List->Items->Add("RLCLC:CELL="+Cell2->Text+",CSPSALLOC="+Cspsallocc2->Text+";");
List->Items->Add("RLSBC:CELL="+Cell2->Text+",CB="+Cb->Text+",ACC="+Acc->Text+",MAXRET="+Maxret->Text+",TX="+Tx->Text+",ATT="+Att->Text+",T3212="+T3212->Text+",ECSC="+Ecsc->Text+";");
List->Items->Add("RLSBC:CELL="+Cell2->Text+",CBQ="+Cbq->Text+",CRO="+Cro->Text+",TO="+To->Text+",PT="+Pt->Text+";");
List->Items->Add("RLIHC:CELL="+Cell2->Text+",IHO="+Iho->Text+",MAXIHO="+Maxiho->Text+",TMAXIHO="+Tmaxiho->Text+",TIHO="+Tiho->Text+";");
List->Items->Add("RLIHC:CELL="+Cell2->Text+",SSOFFSETULP="+Ssoffsetulp->Text+",QOFFSETULP="+Qoffsetulp->Text+",SSOFFSETDLP="+Ssoffsetdlp->Text+",QOFFSETDLP="+Qoffsetdlp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell2->Text+",SSOFFSETULN="+Ssoffsetuln->Text+",QOFFSETULN="+Qoffsetuln->Text+",SSOFFSETDLN="+Ssoffsetdln->Text+",QOFFSETDLN="+Qoffsetdln->Text+";");
List->Items->Add("RLIHC:CELL="+Cell2->Text+",SSOFFSETULAFRP="+Ssoffsetulafrp->Text+",QOFFSETULAFRP="+Qoffsetulafrp->Text+",SSOFFSETDLAFRP="+Ssoffsetdlafrp->Text+",QOFFSETDLAFRP="+Qoffsetdlafrp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell2->Text+",SSOFFSETULAFRN="+Ssoffsetulafrn->Text+",QOFFSETULAFRN="+Qoffsetulafrn->Text+",SSOFFSETDLAFRN="+Ssoffsetdlafrn->Text+",QOFFSETDLAFRN="+Qoffsetdlafrn->Text+";");
List->Items->Add("RLLHC:CELL="+Cell2->Text+",LAYER="+Levelc2->Text+",LAYERTHR="+Levthrc2->Text+",LAYERHYST="+Layerhystc2->Text+",PSSTEMP="+Psstemp->Text+",PTIMTEMP="+Ptimtemp->Text+";");
if(Dmpstate->Text=="ACTIVE")
List->Items->Add("RLPCI:CELL="+Cell2->Text+";");
List->Items->Add("RLPCC:CELL="+Cell2->Text+",SSDESUL="+Ssdesul->Text+",LCOMPUL="+Lcompul->Text+",QDESUL="+Qdesul->Text+",QCOMPUL="+Qcompul->Text+";");
if(Dbpstate->Text=="ACTIVE")
List->Items->Add("RLBCI:CELL="+Cell2->Text+";");
List->Items->Add("RLBCC:CELL="+Cell2->Text+",SSDESDL="+Ssdesdl->Text+",LCOMPDL="+Lcompdl->Text+",QDESDL="+Qdesdl->Text+",QCOMPDL="+Qcompdl->Text+";");
List->Items->Add("RLCDC:CELL="+Cell2->Text+",MC="+Mc->Text+";");
List->Items->Add("RLGSI:CELL="+Cell2->Text+";");
List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch0c2->Text+",CHGR=0;");
if(Form3->Fhop->ItemIndex==1)
{
List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch1c2->Text+",CHGR=1,MAIO="+Maioch1c2->Text+",HSN="+Hsnch1c2->Text+";");
 if(Addch2c2->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch2c2->Text+",CHGR=2,MAIO="+Maioch2c2->Text+",HSN="+Hsnch2c2->Text+";");
 if(Addch3c2->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch3c2->Text+",CHGR=3,MAIO="+Maioch3c2->Text+",HSN="+Hsnch3c2->Text+";");
}
else
{
if(Addch1c2->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch1c2->Text+",CHGR=1;");
if(Addch2c2->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch2c2->Text+",CHGR=2;");
if(Addch3c2->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell2->Text+",HOP="+Hopch3c2->Text+",CHGR=3;");
}
if(Amrpcstate->Text=="ACTIVE")
List->Items->Add("RLAPI:CELL="+Cell2->Text+";");
List->Items->Add("RLAPC:CELL="+Cell2->Text+",SSDESDLAFR="+Ssdesdlafr->Text+",QDESDLAFR="+Qdesdlafr->Text+",SSDESULAFR="+Ssdesulafr->Text+",QDESULAFR="+Qdesulafr->Text+";");
List->Items->Add("RLAPC:CELL="+Cell2->Text+",SSDESDLAHR="+Ssdesdlahr->Text+",QDESDLAHR="+Qdesdlahr->Text+",SSDESULAHR="+Ssdesulahr->Text+",QDESULAHR="+Qdesulahr->Text+";");
List->Items->Add("RLGAC:CELL="+Cell2->Text+",CHGR=0,SAS="+Sas->Text+";");
if(Addch1c2->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell2->Text+",CHGR=1,SAS="+Sas->Text+";");
if(Addch2c2->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell2->Text+",CHGR=2,SAS="+Sas->Text+";");
if(Addch3c2->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell2->Text+",CHGR=3,SAS="+Sas->Text+";");
List->Items->Add("RLGSC:CELL="+Cell2->Text+",FPDCH="+Fpdch->Text+",GAMMA="+Gamma->Text+",LA="+La->Text+";");
List->Items->Add("RLDUI:CELL="+Cell2->Text+";");
List->Items->Add("RLDMI:CELL="+Cell2->Text+";");
List->Items->Add("RLDMC:CELL="+Cell2->Text+",DMQB="+Dmqb->Text+",DMQG="+Dmqg->Text+";");
List->Items->Add("");
}
...
if(Tabc3->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell3->Text+" CELL DEFINITION");
List->Items->Add("RLDEI:CELL="+Cell3->Text+",CSYSTYPE="+Form3->Csystype->Text+";");
List->Items->Add("RLDEC:CELL="+Cell3->Text+",CGI="+Cgic3->Text+",BSIC="+Bsicc3->Text+",BCCHNO="+Bcchnoc3->Text+",MFRMS="+Mfrms->Text+",BCCHTYPE="+Bcchtype->Text+",AGBLK="+Agblk->Text+",FNOFFSET="+Fnoffset->Text+",IRC="+Irc->Text+";");
List->Items->Add("RLDHC:CELL="+Cell3->Text+",DHA="+Dha->Text+",DTHNAMR="+Dthnamr->Text+";");
if(Form3->Fhop->ItemIndex==0)
if(Tchch0c3->Text!="")
List->Items->Add("RLCFI:CELL="+Cell3->Text+",DCHNO="+Tchch0c3->Text+",CHGR=0;");
List->Items->Add("RLCCC:CELL="+Cell3->Text+",CHGR=0,SDCCH="+Sdcchchgr0c3->Text+",CBCH=YES,TN="+Tnchgr0c3->Text+";");
if(Addch1c3->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell3->Text+",CHGR=1;");
List->Items->Add("RLCFI:CELL="+Cell3->Text+",DCHNO="+Tchch1c3->Text+",CHGR=1;");
List->Items->Add("RLCCC:CELL="+Cell3->Text+",CHGR=1,SDCCH="+Sdcchchgr1c3->Text+",CBCH=NO,TN="+Tnchgr1c3->Text+";");
}
if(Addch2c3->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell3->Text+",CHGR=2;");
List->Items->Add("RLCFI:CELL="+Cell3->Text+",DCHNO="+Tchch2c3->Text+",CHGR=2;");
List->Items->Add("RLCCC:CELL="+Cell3->Text+",CHGR=2,SDCCH="+Sdcchchgr2c3->Text+",CBCH=NO,TN="+Tnchgr2c3->Text+";");
}
if(Addch3c3->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell3->Text+",CHGR=3;");
List->Items->Add("RLCFI:CELL="+Cell3->Text+",DCHNO="+Tchch3c3->Text+",CHGR=3;");
List->Items->Add("RLCCC:CELL="+Cell3->Text+",CHGR=3,SDCCH="+Sdcchchgr3c3->Text+",CBCH=NO,TN="+Tnchgr3c3->Text+";");
}

List->Items->Add("RLCPC:CELL="+Cell3->Text+",BSPWRT="+Bspwrtc3->Text+",BSPWRB="+Bspwrbc3->Text+",MSTXPWR="+Mstxpwr->Text+";");
List->Items->Add("RLCXC:CELL="+Cell3->Text+",DTXD="+Dtxd->Text+";");
List->Items->Add("RLLOC:CELL="+Cell3->Text+",BSPWR="+Bspwrc3->Text+",BSTXPWR="+Bstxpwrc3->Text+",BSRXMIN="+Bsrxminc3->Text+",BSRXSUFF="+Bsrxsuffc3->Text+",MSRXMIN="+Msrxminc3->Text+",MSRXSUFF="+Msrxsuff->Text+";");
List->Items->Add("RLLOC:CELL="+Cell3->Text+",SCHO="+Scho->Text+",MISSNM="+Missnm->Text+",AW="+Awc3->Text+";");
List->Items->Add("RLLUC:CELL="+Cell3->Text+",QLIMUL="+Qlimul->Text+",QLIMDL="+Qlimdl->Text+",TALIM="+Talimc3->Text+",CELLQ="+Cellq->Text+";");
List->Items->Add("RLLUC:CELL="+Cell3->Text+",QLIMULAFR="+Qlimulafr->Text+",QLIMDLAFR="+Qlimdlafr->Text+";");
List->Items->Add("RLLPC:CELL="+Cell3->Text+",PTIMHF="+Ptimhf->Text+",PTIMBQ="+Ptimbq->Text+",PTIMTA="+Ptimta->Text+",PSSHF="+Psshf->Text+",PSSBQ="+Pssbq->Text+",PSSTA="+Pssta->Text+";");
List->Items->Add("RLLFC:CELL="+Cell3->Text+",SSEVALSD="+Ssevalsd->Text+",QEVALSD="+Qevalsd->Text+",SSEVALSI="+Ssevalsi->Text+",QEVALSI="+Qevalsi->Text+";");
List->Items->Add("RLLFC:CELL="+Cell3->Text+",SSLENSD="+Sslensd->Text+",QLENSD="+Qlensd->Text+",SSLENSI="+Sslensi->Text+",QLENSI="+Qlensi->Text+",SSRAMPSD="+Ssrampsd->Text+",SSRAMPSI="+Ssrampsi->Text+";");
List->Items->Add("RLLDC:CELL="+Cell3->Text+",MAXTA="+Maxta->Text+",RLINKUP="+Rlinkup->Text+",RLINKUPAFR="+Rlinkupafr->Text+",RLINKUPAHR="+Rlinkupahr->Text+";");
List->Items->Add("RLLCI:CELL="+Cell3->Text+";");
List->Items->Add("RLLCC:CELL="+Cell3->Text+",CLSLEVEL="+Clslevel->Text+",CLSACC="+Clsacc->Text+",HOCLSACC="+Hoclsacc->Text+",RHYST="+Rhyst->Text+",CLSRAMP="+Clsramp->Text+";");
List->Items->Add("RLSSC:CELL="+Cell3->Text+",ACCMIN="+Accmin->Text+",CCHPWR="+Cchpwr->Text+",CRH="+Crhc3->Text+",DTXU="+Dtxu->Text+",NCCPERM="+Nccperm->Text+",RLINKT="+Rlinkt->Text+",RLINKTAFR="+Rlinktafr->Text+",RLINKTAHR="+Rlinktahr->Text+";");
List->Items->Add("RLHPC:CELL="+Cell3->Text+",CHAP="+Chapc3->Text+";");
List->Items->Add("RLCLC:CELL="+Cell3->Text+",CSPSALLOC="+Cspsallocc3->Text+";");
List->Items->Add("RLSBC:CELL="+Cell3->Text+",CB="+Cb->Text+",ACC="+Acc->Text+",MAXRET="+Maxret->Text+",TX="+Tx->Text+",ATT="+Att->Text+",T3212="+T3212->Text+",ECSC="+Ecsc->Text+";");
List->Items->Add("RLSBC:CELL="+Cell3->Text+",CBQ="+Cbq->Text+",CRO="+Cro->Text+",TO="+To->Text+",PT="+Pt->Text+";");
List->Items->Add("RLIHC:CELL="+Cell3->Text+",IHO="+Iho->Text+",MAXIHO="+Maxiho->Text+",TMAXIHO="+Tmaxiho->Text+",TIHO="+Tiho->Text+";");
List->Items->Add("RLIHC:CELL="+Cell3->Text+",SSOFFSETULP="+Ssoffsetulp->Text+",QOFFSETULP="+Qoffsetulp->Text+",SSOFFSETDLP="+Ssoffsetdlp->Text+",QOFFSETDLP="+Qoffsetdlp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell3->Text+",SSOFFSETULN="+Ssoffsetuln->Text+",QOFFSETULN="+Qoffsetuln->Text+",SSOFFSETDLN="+Ssoffsetdln->Text+",QOFFSETDLN="+Qoffsetdln->Text+";");
List->Items->Add("RLIHC:CELL="+Cell3->Text+",SSOFFSETULAFRP="+Ssoffsetulafrp->Text+",QOFFSETULAFRP="+Qoffsetulafrp->Text+",SSOFFSETDLAFRP="+Ssoffsetdlafrp->Text+",QOFFSETDLAFRP="+Qoffsetdlafrp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell3->Text+",SSOFFSETULAFRN="+Ssoffsetulafrn->Text+",QOFFSETULAFRN="+Qoffsetulafrn->Text+",SSOFFSETDLAFRN="+Ssoffsetdlafrn->Text+",QOFFSETDLAFRN="+Qoffsetdlafrn->Text+";");
List->Items->Add("RLLHC:CELL="+Cell3->Text+",LAYER="+Levelc3->Text+",LAYERTHR="+Levthrc3->Text+",LAYERHYST="+Layerhystc3->Text+",PSSTEMP="+Psstemp->Text+",PTIMTEMP="+Ptimtemp->Text+";");
if(Dmpstate->Text=="ACTIVE")
List->Items->Add("RLPCI:CELL="+Cell3->Text+";");
List->Items->Add("RLPCC:CELL="+Cell3->Text+",SSDESUL="+Ssdesul->Text+",LCOMPUL="+Lcompul->Text+",QDESUL="+Qdesul->Text+",QCOMPUL="+Qcompul->Text+";");
if(Dbpstate->Text=="ACTIVE")
List->Items->Add("RLBCI:CELL="+Cell3->Text+";");
List->Items->Add("RLBCC:CELL="+Cell3->Text+",SSDESDL="+Ssdesdl->Text+",LCOMPDL="+Lcompdl->Text+",QDESDL="+Qdesdl->Text+",QCOMPDL="+Qcompdl->Text+";");
List->Items->Add("RLCDC:CELL="+Cell3->Text+",MC="+Mc->Text+";");
List->Items->Add("RLGSI:CELL="+Cell3->Text+";");
List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch0c3->Text+",CHGR=0;");
if(Form3->Fhop->ItemIndex==1)
{
List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch1c3->Text+",CHGR=1,MAIO="+Maioch1c3->Text+",HSN="+Hsnch1c3->Text+";");
 if(Addch2c3->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch2c3->Text+",CHGR=2,MAIO="+Maioch2c3->Text+",HSN="+Hsnch2c3->Text+";");
 if(Addch3c3->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch3c3->Text+",CHGR=3,MAIO="+Maioch3c3->Text+",HSN="+Hsnch3c3->Text+";");
}
else
{
if(Addch1c3->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch1c3->Text+",CHGR=1;");
if(Addch2c3->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch2c3->Text+",CHGR=2;");
if(Addch3c3->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell3->Text+",HOP="+Hopch3c3->Text+",CHGR=3;");
}
if(Amrpcstate->Text=="ACTIVE")
List->Items->Add("RLAPI:CELL="+Cell3->Text+";");
List->Items->Add("RLAPC:CELL="+Cell3->Text+",SSDESDLAFR="+Ssdesdlafr->Text+",QDESDLAFR="+Qdesdlafr->Text+",SSDESULAFR="+Ssdesulafr->Text+",QDESULAFR="+Qdesulafr->Text+";");
List->Items->Add("RLAPC:CELL="+Cell3->Text+",SSDESDLAHR="+Ssdesdlahr->Text+",QDESDLAHR="+Qdesdlahr->Text+",SSDESULAHR="+Ssdesulahr->Text+",QDESULAHR="+Qdesulahr->Text+";");
List->Items->Add("RLGAC:CELL="+Cell3->Text+",CHGR=0,SAS="+Sas->Text+";");
if(Addch1c3->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell3->Text+",CHGR=1,SAS="+Sas->Text+";");
if(Addch2c3->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell3->Text+",CHGR=2,SAS="+Sas->Text+";");
if(Addch3c3->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell3->Text+",CHGR=3,SAS="+Sas->Text+";");
List->Items->Add("RLGSC:CELL="+Cell3->Text+",FPDCH="+Fpdch->Text+",GAMMA="+Gamma->Text+",LA="+La->Text+";");
List->Items->Add("RLDUI:CELL="+Cell3->Text+";");
List->Items->Add("RLDMI:CELL="+Cell3->Text+";");
List->Items->Add("RLDMC:CELL="+Cell3->Text+",DMQB="+Dmqb->Text+",DMQG="+Dmqg->Text+";");
List->Items->Add("");
}
...
if(Tabc4->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell4->Text+" CELL DEFINITION");
List->Items->Add("RLDEI:CELL="+Cell4->Text+",CSYSTYPE="+Form3->Csystype->Text+";");
List->Items->Add("RLDEC:CELL="+Cell4->Text+",CGI="+Cgic4->Text+",BSIC="+Bsicc4->Text+",BCCHNO="+Bcchnoc4->Text+",MFRMS="+Mfrms->Text+",BCCHTYPE="+Bcchtype->Text+",AGBLK="+Agblk->Text+",FNOFFSET="+Fnoffset->Text+",IRC="+Irc->Text+";");
List->Items->Add("RLDHC:CELL="+Cell4->Text+",DHA="+Dha->Text+",DTHNAMR="+Dthnamr->Text+";");
if(Form3->Fhop->ItemIndex==0)
if(Tchch0c4->Text!="")
List->Items->Add("RLCFI:CELL="+Cell4->Text+",DCHNO="+Tchch0c4->Text+",CHGR=0;");
List->Items->Add("RLCCC:CELL="+Cell4->Text+",CHGR=0,SDCCH="+Sdcchchgr0c4->Text+",CBCH=YES,TN="+Tnchgr0c4->Text+";");
if(Addch1c4->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell4->Text+",CHGR=1;");
List->Items->Add("RLCFI:CELL="+Cell4->Text+",DCHNO="+Tchch1c4->Text+",CHGR=1;");
List->Items->Add("RLCCC:CELL="+Cell4->Text+",CHGR=1,SDCCH="+Sdcchchgr1c4->Text+",CBCH=NO,TN="+Tnchgr1c4->Text+";");
}
if(Addch2c4->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell4->Text+",CHGR=2;");
List->Items->Add("RLCFI:CELL="+Cell4->Text+",DCHNO="+Tchch2c4->Text+",CHGR=2;");
List->Items->Add("RLCCC:CELL="+Cell4->Text+",CHGR=2,SDCCH="+Sdcchchgr2c4->Text+",CBCH=NO,TN="+Tnchgr2c4->Text+";");
}
if(Addch3c4->Checked==true)
{
List->Items->Add("RLDGI:CELL="+Cell4->Text+",CHGR=3;");
List->Items->Add("RLCFI:CELL="+Cell4->Text+",DCHNO="+Tchch3c4->Text+",CHGR=3;");
List->Items->Add("RLCCC:CELL="+Cell4->Text+",CHGR=3,SDCCH="+Sdcchchgr3c4->Text+",CBCH=NO,TN="+Tnchgr3c4->Text+";");
}

List->Items->Add("RLCPC:CELL="+Cell4->Text+",BSPWRT="+Bspwrtc4->Text+",BSPWRB="+Bspwrbc4->Text+",MSTXPWR="+Mstxpwr->Text+";");
List->Items->Add("RLCXC:CELL="+Cell4->Text+",DTXD="+Dtxd->Text+";");
List->Items->Add("RLLOC:CELL="+Cell4->Text+",BSPWR="+Bspwrc4->Text+",BSTXPWR="+Bstxpwrc4->Text+",BSRXMIN="+Bsrxminc4->Text+",BSRXSUFF="+Bsrxsuffc4->Text+",MSRXMIN="+Msrxminc4->Text+",MSRXSUFF="+Msrxsuff->Text+";");
List->Items->Add("RLLOC:CELL="+Cell4->Text+",SCHO="+Scho->Text+",MISSNM="+Missnm->Text+",AW="+Awc4->Text+";");
List->Items->Add("RLLUC:CELL="+Cell4->Text+",QLIMUL="+Qlimul->Text+",QLIMDL="+Qlimdl->Text+",TALIM="+Talimc4->Text+",CELLQ="+Cellq->Text+";");
List->Items->Add("RLLUC:CELL="+Cell4->Text+",QLIMULAFR="+Qlimulafr->Text+",QLIMDLAFR="+Qlimdlafr->Text+";");
List->Items->Add("RLLPC:CELL="+Cell4->Text+",PTIMHF="+Ptimhf->Text+",PTIMBQ="+Ptimbq->Text+",PTIMTA="+Ptimta->Text+",PSSHF="+Psshf->Text+",PSSBQ="+Pssbq->Text+",PSSTA="+Pssta->Text+";");
List->Items->Add("RLLFC:CELL="+Cell4->Text+",SSEVALSD="+Ssevalsd->Text+",QEVALSD="+Qevalsd->Text+",SSEVALSI="+Ssevalsi->Text+",QEVALSI="+Qevalsi->Text+";");
List->Items->Add("RLLFC:CELL="+Cell4->Text+",SSLENSD="+Sslensd->Text+",QLENSD="+Qlensd->Text+",SSLENSI="+Sslensi->Text+",QLENSI="+Qlensi->Text+",SSRAMPSD="+Ssrampsd->Text+",SSRAMPSI="+Ssrampsi->Text+";");
List->Items->Add("RLLDC:CELL="+Cell4->Text+",MAXTA="+Maxta->Text+",RLINKUP="+Rlinkup->Text+",RLINKUPAFR="+Rlinkupafr->Text+",RLINKUPAHR="+Rlinkupahr->Text+";");
List->Items->Add("RLLCI:CELL="+Cell4->Text+";");
List->Items->Add("RLLCC:CELL="+Cell4->Text+",CLSLEVEL="+Clslevel->Text+",CLSACC="+Clsacc->Text+",HOCLSACC="+Hoclsacc->Text+",RHYST="+Rhyst->Text+",CLSRAMP="+Clsramp->Text+";");
List->Items->Add("RLSSC:CELL="+Cell4->Text+",ACCMIN="+Accmin->Text+",CCHPWR="+Cchpwr->Text+",CRH="+Crhc4->Text+",DTXU="+Dtxu->Text+",NCCPERM="+Nccperm->Text+",RLINKT="+Rlinkt->Text+",RLINKTAFR="+Rlinktafr->Text+",RLINKTAHR="+Rlinktahr->Text+";");
List->Items->Add("RLHPC:CELL="+Cell4->Text+",CHAP="+Chapc4->Text+";");
List->Items->Add("RLCLC:CELL="+Cell4->Text+",CSPSALLOC="+Cspsallocc4->Text+";");
List->Items->Add("RLSBC:CELL="+Cell4->Text+",CB="+Cb->Text+",ACC="+Acc->Text+",MAXRET="+Maxret->Text+",TX="+Tx->Text+",ATT="+Att->Text+",T3212="+T3212->Text+",ECSC="+Ecsc->Text+";");
List->Items->Add("RLSBC:CELL="+Cell4->Text+",CBQ="+Cbq->Text+",CRO="+Cro->Text+",TO="+To->Text+",PT="+Pt->Text+";");
List->Items->Add("RLIHC:CELL="+Cell4->Text+",IHO="+Iho->Text+",MAXIHO="+Maxiho->Text+",TMAXIHO="+Tmaxiho->Text+",TIHO="+Tiho->Text+";");
List->Items->Add("RLIHC:CELL="+Cell4->Text+",SSOFFSETULP="+Ssoffsetulp->Text+",QOFFSETULP="+Qoffsetulp->Text+",SSOFFSETDLP="+Ssoffsetdlp->Text+",QOFFSETDLP="+Qoffsetdlp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell4->Text+",SSOFFSETULN="+Ssoffsetuln->Text+",QOFFSETULN="+Qoffsetuln->Text+",SSOFFSETDLN="+Ssoffsetdln->Text+",QOFFSETDLN="+Qoffsetdln->Text+";");
List->Items->Add("RLIHC:CELL="+Cell4->Text+",SSOFFSETULAFRP="+Ssoffsetulafrp->Text+",QOFFSETULAFRP="+Qoffsetulafrp->Text+",SSOFFSETDLAFRP="+Ssoffsetdlafrp->Text+",QOFFSETDLAFRP="+Qoffsetdlafrp->Text+";");
List->Items->Add("RLIHC:CELL="+Cell4->Text+",SSOFFSETULAFRN="+Ssoffsetulafrn->Text+",QOFFSETULAFRN="+Qoffsetulafrn->Text+",SSOFFSETDLAFRN="+Ssoffsetdlafrn->Text+",QOFFSETDLAFRN="+Qoffsetdlafrn->Text+";");
List->Items->Add("RLLHC:CELL="+Cell4->Text+",LAYER="+Levelc4->Text+",LAYERTHR="+Levthrc4->Text+",LAYERHYST="+Layerhystc4->Text+",PSSTEMP="+Psstemp->Text+",PTIMTEMP="+Ptimtemp->Text+";");
if(Dmpstate->Text=="ACTIVE")
List->Items->Add("RLPCI:CELL="+Cell4->Text+";");
List->Items->Add("RLPCC:CELL="+Cell4->Text+",SSDESUL="+Ssdesul->Text+",LCOMPUL="+Lcompul->Text+",QDESUL="+Qdesul->Text+",QCOMPUL="+Qcompul->Text+";");
if(Dbpstate->Text=="ACTIVE")
List->Items->Add("RLBCI:CELL="+Cell4->Text+";");
List->Items->Add("RLBCC:CELL="+Cell4->Text+",SSDESDL="+Ssdesdl->Text+",LCOMPDL="+Lcompdl->Text+",QDESDL="+Qdesdl->Text+",QCOMPDL="+Qcompdl->Text+";");
List->Items->Add("RLCDC:CELL="+Cell4->Text+",MC="+Mc->Text+";");
List->Items->Add("RLGSI:CELL="+Cell4->Text+";");
List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch0c4->Text+",CHGR=0;");
if(Form3->Fhop->ItemIndex==1)
{
List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch1c4->Text+",CHGR=1,MAIO="+Maioch1c4->Text+",HSN="+Hsnch1c4->Text+";");
 if(Addch2c4->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch2c4->Text+",CHGR=2,MAIO="+Maioch2c4->Text+",HSN="+Hsnch2c4->Text+";");
 if(Addch3c4->Checked==true)
 List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch3c4->Text+",CHGR=3,MAIO="+Maioch3c4->Text+",HSN="+Hsnch3c4->Text+";");
}
else
{
if(Addch1c4->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch1c4->Text+",CHGR=1;");
if(Addch2c4->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch2c4->Text+",CHGR=2;");
if(Addch3c4->Checked==true)
List->Items->Add("RLCHC:CELL="+Cell4->Text+",HOP="+Hopch3c4->Text+",CHGR=3;");
}
if(Amrpcstate->Text=="ACTIVE")
List->Items->Add("RLAPI:CELL="+Cell4->Text+";");
List->Items->Add("RLAPC:CELL="+Cell4->Text+",SSDESDLAFR="+Ssdesdlafr->Text+",QDESDLAFR="+Qdesdlafr->Text+",SSDESULAFR="+Ssdesulafr->Text+",QDESULAFR="+Qdesulafr->Text+";");
List->Items->Add("RLAPC:CELL="+Cell4->Text+",SSDESDLAHR="+Ssdesdlahr->Text+",QDESDLAHR="+Qdesdlahr->Text+",SSDESULAHR="+Ssdesulahr->Text+",QDESULAHR="+Qdesulahr->Text+";");
List->Items->Add("RLGAC:CELL="+Cell4->Text+",CHGR=0,SAS="+Sas->Text+";");
if(Addch1c4->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell4->Text+",CHGR=1,SAS="+Sas->Text+";");
if(Addch2c4->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell4->Text+",CHGR=2,SAS="+Sas->Text+";");
if(Addch3c4->Checked==true)
List->Items->Add("RLGAC:CELL="+Cell4->Text+",CHGR=3,SAS="+Sas->Text+";");
List->Items->Add("RLGSC:CELL="+Cell4->Text+",FPDCH="+Fpdch->Text+",GAMMA="+Gamma->Text+",LA="+La->Text+";");
List->Items->Add("RLDUI:CELL="+Cell4->Text+";");
List->Items->Add("RLDMI:CELL="+Cell4->Text+";");
List->Items->Add("RLDMC:CELL="+Cell4->Text+",DMQB="+Dmqb->Text+",DMQG="+Dmqg->Text+";");
List->Items->Add("");
}

if(Form3->Edge->Visible==true)
{
List->Items->Add("RLBDC:CELL="+Cell1->Text+",NUMREQBPC="+Form3->Numreqbpcch0c1->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch0c1->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch0c1->Text+",CHGR=0,TN7BCCH="+Form3->Tn7bcchch0c1->Text+";");
List->Items->Add("RLBDC:CELL="+Cell1->Text+",NUMREQBPC="+Form3->Numreqbpcch1c1->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch1c1->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch1c1->Text+",CHGR=1;");
List->Items->Add("");

if(Tabc2->TabVisible==true){
List->Items->Add("RLBDC:CELL="+Cell2->Text+",NUMREQBPC="+Form3->Numreqbpcch0c2->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch0c2->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch0c2->Text+",CHGR=0,TN7BCCH="+Form3->Tn7bcchch0c2->Text+";");
List->Items->Add("RLBDC:CELL="+Cell2->Text+",NUMREQBPC="+Form3->Numreqbpcch1c2->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch1c2->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch1c2->Text+",CHGR=1;");
List->Items->Add("");}

if(Tabc3->TabVisible==true){
List->Items->Add("RLBDC:CELL="+Cell3->Text+",NUMREQBPC="+Form3->Numreqbpcch0c3->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch0c3->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch0c3->Text+",CHGR=0,TN7BCCH="+Form3->Tn7bcchch0c3->Text+";");
List->Items->Add("RLBDC:CELL="+Cell3->Text+",NUMREQBPC="+Form3->Numreqbpcch1c3->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch1c3->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch1c3->Text+",CHGR=1;");
List->Items->Add("");}

if(Tabc4->TabVisible==true){
List->Items->Add("RLBDC:CELL="+Cell4->Text+",NUMREQBPC="+Form3->Numreqbpcch0c4->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch0c4->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch0c4->Text+",CHGR=0,TN7BCCH="+Form3->Tn7bcchch0c4->Text+";");
List->Items->Add("RLBDC:CELL="+Cell4->Text+",NUMREQBPC="+Form3->Numreqbpcch1c4->Text+",NUMREQEGPRSBPC="+Form3->Numreqegprsbpcch1c4->Text+",NUMREQCS3CS4BPC="+Form3->Numreqcs3cs4bpcch1c4->Text+",CHGR=1;");
List->Items->Add("");}
}
...
List->Items->Add("@COMMENT MO DEFINITION");
List->Items->Add("RXMOI:MO=RXOTG-"+Form3->Tgk1->Text+",COMB="+Combc1->Text+",RSITE="+Rsitec1->Text+",SWVER="+Form3->Swverk1->Text+";");

if(Form3->Tru1k1->Color==clFuchsia || Form3->Tru2k1->Color==clFuchsia || Form3->Tru3k1->Color==clFuchsia || Form3->Tru4k1->Color==clFuchsia ||
Form3->Tru5k1->Color==clFuchsia || Form3->Tru6k1->Color==clFuchsia || Form3->Tru7k1->Color==clFuchsia || Form3->Tru8k1->Color==clFuchsia ||
Form3->Tru9k1->Color==clFuchsia || Form3->Tru10k1->Color==clFuchsia || Form3->Tru11k1->Color==clFuchsia || Form3->Tru12k1->Color==clFuchsia)
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell1->Text+",CHGR=0;");
if(Addch1c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell1->Text+",CHGR=1;");
if(Addch2c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell1->Text+",CHGR=2;");
if(Addch3c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell1->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell2->Text+",CHGR=0;");
if(Addch1c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell2->Text+",CHGR=1;");
if(Addch2c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell2->Text+",CHGR=2;");
if(Addch3c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell2->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell3->Text+",CHGR=0;");
if(Addch1c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell3->Text+",CHGR=1;");
if(Addch2c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell3->Text+",CHGR=2;");
if(Addch3c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell3->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell4->Text+",CHGR=0;");
if(Addch1c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell4->Text+",CHGR=1;");
if(Addch2c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell4->Text+",CHGR=2;");
if(Addch3c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk1->Text+",CELL="+Cell4->Text+",CHGR=3;");
}

List->Items->Add("RXMOC:MO=RXOTG-"+Form3->Tgk1->Text+",FHOP="+Form3->Fhop->Text+",TRACO=POOL,CONFMD=NODEL;");
List->Items->Add("RXMOI:MO=RXOCF-"+Form3->Tgk1->Text+",TEI="+Form3->Teik1->Text+";");
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk1->Text+"-0,DEV=RXODPI-"+(StrToInt(Form3->Tgk1->Text)*2)+";");
if(Form3->Odp1k1->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk1->Text+"-1,DEV=RXODPI-"+((StrToInt(Form3->Tgk1->Text)*2)+1)+";");
if(Form3->Odp3k1->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk1->Text+"-3,DEV=RXODPI-"+((StrToInt(Form3->Tgk1->Text)*2)+3)+";");
List->Items->Add("RXMOI:MO=RXOIS-"+Form3->Tgk1->Text+";");
List->Items->Add("RXMOI:MO=RXOTF-"+Form3->Tgk1->Text+",TFMODE="+Form3->Tfmodek1->Text+";");
List->Items->Add("RXALC:MO=RXOTG-"+Form3->Tgk1->Text+",TGCOORD=ON,ALMASK=MAINS;");
List->Items->Add("");
...
if(Form3->K2->Visible==true)//K2 movcuddursa
 {
List->Items->Add("RXMOI:MO=RXOTG-"+Form3->Tgk2->Text+",COMB="+Combc1->Text+",RSITE="+Rsitec1->Text+",SWVER="+Form3->Swverk2->Text+";");
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell1->Text+",CHGR=0;");
if(Addch1c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell1->Text+",CHGR=1;");
if(Addch2c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell1->Text+",CHGR=2;");
if(Addch3c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell1->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell2->Text+",CHGR=0;");
if(Addch1c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell2->Text+",CHGR=1;");
if(Addch2c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell2->Text+",CHGR=2;");
if(Addch3c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell2->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell3->Text+",CHGR=0;");
if(Addch1c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell3->Text+",CHGR=1;");
if(Addch2c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell3->Text+",CHGR=2;");
if(Addch3c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell3->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell4->Text+",CHGR=0;");
if(Addch1c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell4->Text+",CHGR=1;");
if(Addch2c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell4->Text+",CHGR=2;");
if(Addch3c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk2->Text+",CELL="+Cell4->Text+",CHGR=3;");
}

List->Items->Add("RXMOC:MO=RXOTG-"+Form3->Tgk2->Text+",FHOP="+Form3->Fhop->Text+",TRACO=POOL,CONFMD=NODEL;");
List->Items->Add("RXMOI:MO=RXOCF-"+Form3->Tgk2->Text+",TEI="+Form3->Teik2->Text+";");
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk2->Text+"-0,DEV=RXODPI-"+(StrToInt(Form3->Tgk2->Text)*2)+";");
if(Form3->Odp1k2->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk2->Text+"-1,DEV=RXODPI-"+((StrToInt(Form3->Tgk2->Text)*2)+1)+";");
if(Form3->Odp3k2->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk2->Text+"-3,DEV=RXODPI-"+((StrToInt(Form3->Tgk2->Text)*2)+3)+";");
List->Items->Add("RXMOI:MO=RXOIS-"+Form3->Tgk2->Text+";");
List->Items->Add("RXMOI:MO=RXOTF-"+Form3->Tgk2->Text+",TFMODE="+Form3->Tfmodek2->Text+";");
List->Items->Add("RXALC:MO=RXOTG-"+Form3->Tgk2->Text+",TGCOORD=ON,ALMASK=MAINS;");
List->Items->Add("");
 }

if(Form3->K3->Visible==true)//K3 movcuddursa
 {
List->Items->Add("RXMOI:MO=RXOTG-"+Form3->Tgk3->Text+",COMB="+Combc1->Text+",RSITE="+Rsitec1->Text+",SWVER="+Form3->Swverk3->Text+";");
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell1->Text+",CHGR=0;");
if(Addch1c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell1->Text+",CHGR=1;");
if(Addch2c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell1->Text+",CHGR=2;");
if(Addch3c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell1->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell2->Text+",CHGR=0;");
if(Addch1c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell2->Text+",CHGR=1;");
if(Addch2c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell2->Text+",CHGR=2;");
if(Addch3c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell2->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell3->Text+",CHGR=0;");
if(Addch1c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell3->Text+",CHGR=1;");
if(Addch2c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell3->Text+",CHGR=2;");
if(Addch3c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell3->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell4->Text+",CHGR=0;");
if(Addch1c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell4->Text+",CHGR=1;");
if(Addch2c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell4->Text+",CHGR=2;");
if(Addch3c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk3->Text+",CELL="+Cell4->Text+",CHGR=3;");
}

List->Items->Add("RXMOC:MO=RXOTG-"+Form3->Tgk3->Text+",FHOP="+Form3->Fhop->Text+",TRACO=POOL,CONFMD=NODEL;");
List->Items->Add("RXMOI:MO=RXOCF-"+Form3->Tgk3->Text+",TEI="+Form3->Teik3->Text+";");
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk3->Text+"-0,DEV=RXODPI-"+(StrToInt(Form3->Tgk3->Text)*2)+";");
if(Form3->Odp1k3->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk3->Text+"-1,DEV=RXODPI-"+((StrToInt(Form3->Tgk3->Text)*2)+1)+";");
if(Form3->Odp3k3->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk3->Text+"-3,DEV=RXODPI-"+((StrToInt(Form3->Tgk3->Text)*2)+3)+";");
List->Items->Add("RXMOI:MO=RXOIS-"+Form3->Tgk3->Text+";");
List->Items->Add("RXMOI:MO=RXOTF-"+Form3->Tgk3->Text+",TFMODE="+Form3->Tfmodek3->Text+";");
List->Items->Add("RXALC:MO=RXOTG-"+Form3->Tgk3->Text+",TGCOORD=ON,ALMASK=MAINS;");
List->Items->Add("");
 }

if(Form3->K4->Visible==true)//K4 movcuddursa
 {
List->Items->Add("RXMOI:MO=RXOTG-"+Form3->Tgk4->Text+",COMB="+Combc1->Text+",RSITE="+Rsitec1->Text+",SWVER="+Form3->Swverk4->Text+";");
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell1->Text+",CHGR=0;");
if(Addch1c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell1->Text+",CHGR=1;");
if(Addch2c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell1->Text+",CHGR=2;");
if(Addch3c1->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell1->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell2->Text+",CHGR=0;");
if(Addch1c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell2->Text+",CHGR=1;");
if(Addch2c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell2->Text+",CHGR=2;");
if(Addch3c2->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell2->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell3->Text+",CHGR=0;");
if(Addch1c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell3->Text+",CHGR=1;");
if(Addch2c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell3->Text+",CHGR=2;");
if(Addch3c3->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell3->Text+",CHGR=3;");
}
...
{
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell4->Text+",CHGR=0;");
if(Addch1c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell4->Text+",CHGR=1;");
if(Addch2c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell4->Text+",CHGR=2;");
if(Addch3c4->Checked==true)
List->Items->Add("RXTCI:MO=RXOTG-"+Form3->Tgk4->Text+",CELL="+Cell4->Text+",CHGR=3;");
}

List->Items->Add("RXMOC:MO=RXOTG-"+Form3->Tgk4->Text+",FHOP="+Form3->Fhop->Text+",TRACO=POOL,CONFMD=NODEL;");
List->Items->Add("RXMOI:MO=RXOCF-"+Form3->Tgk4->Text+",TEI="+Form3->Teik4->Text+";");
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk4->Text+"-0,DEV=RXODPI-"+(StrToInt(Form3->Tgk4->Text)*2)+";");
if(Form3->Odp1k4->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk4->Text+"-1,DEV=RXODPI-"+((StrToInt(Form3->Tgk4->Text)*2)+1)+";");
if(Form3->Odp3k4->Checked==true)
List->Items->Add("RXMOI:MO=RXODP-"+Form3->Tgk4->Text+"-3,DEV=RXODPI-"+((StrToInt(Form3->Tgk4->Text)*2)+3)+";");
List->Items->Add("RXMOI:MO=RXOIS-"+Form3->Tgk4->Text+";");
List->Items->Add("RXMOI:MO=RXOTF-"+Form3->Tgk4->Text+",TFMODE="+Form3->Tfmodek4->Text+";");
List->Items->Add("RXALC:MO=RXOTG-"+Form3->Tgk4->Text+",TGCOORD=ON,ALMASK=MAINS;");
List->Items->Add("");
 }
...
{
//---------------------2 Mbit tanitimi-----------------------------------------------//
List->Items->Add("@COMMENT DIP DEFINITION");
 ...
 if(Form3->Odp0k1->Checked==true)
 {
  ...
  else
  {
   ...
   {
   List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk1->Text+",DCP="+Form3->Dcpek1Edit->Text+",DEV=RBLT2-"+Form3->Devek1Edit->Text+",RES64K;");
   List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devek1Edit->Text+";");
   List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devek1Edit->Text+";");
   List->Items->Add("");
   }

  List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk1->Text+",DCP="+Form3->Dcpk1Edit->Text+",DEV=RBLT2-"+Form3->Devk1Edit->Text+";");
  List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devk1Edit->Text+";");
  List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devk1Edit->Text+";");
  List->Items->Add("");
  }

  List->Items->Add("@COMMENT DIP SUPERVISION");
  List->Items->Add("DTDII:DIP="+Form3->Tgk1->Text+"ODP0,DEV=RXODPI-"+(StrToInt(Form3->Tgk1->Text)*2)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk1->Text+"ODP0,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk1->Text+"ODP0,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP0,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP0,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP0,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP0,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP0,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk1->Text+"ODP0,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk1->Text+"ODP0;");
  List->Items->Add("");

  if(Form3->Odp1k1->Checked==true)
  {
  List->Items->Add("@COMMENT DIP SUPERVISION");
  List->Items->Add("DTDII:DIP="+Form3->Tgk1->Text+"ODP1,DEV=RXODPI-"+((StrToInt(Form3->Tgk1->Text)*2)+1)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk1->Text+"ODP1,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk1->Text+"ODP1,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP1,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP1,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP1,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP1,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP1,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk1->Text+"ODP1,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk1->Text+"ODP1;");
  List->Items->Add("");
  }

  if(Form3->Odp3k1->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk1->Text+"ODP3,DEV=RXODPI-"+((StrToInt(Form3->Tgk1->Text)*2)+3)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk1->Text+"ODP3,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk1->Text+"ODP3,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP3,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk1->Text+"ODP3,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP3,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP3,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk1->Text+"ODP3,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk1->Text+"ODP3,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk1->Text+"ODP3;");
  List->Items->Add("");
  }
}
...
//------------------------------K2 2Mbit-i-------------------------------------------//
 ...
 if(Form3->Odp0k2->Checked==true)
 {
  ...
  else
  {
   ...
   {
   List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk2->Text+",DCP="+Form3->Dcpek2Edit->Text+",DEV=RBLT2-"+Form3->Devek2Edit->Text+",RES64K;");
   List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devek2Edit->Text+";");
   List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devek2Edit->Text+";");
   List->Items->Add("");
   }

  List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk2->Text+",DCP="+Form3->Dcpk2Edit->Text+",DEV=RBLT2-"+Form3->Devk2Edit->Text+";");
  List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devk2Edit->Text+";");
  List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devk2Edit->Text+";");
  List->Items->Add("");
  }

  List->Items->Add("DTDII:DIP="+Form3->Tgk2->Text+"ODP0,DEV=RXODPI-"+(StrToInt(Form3->Tgk2->Text)*2)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk2->Text+"ODP0,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk2->Text+"ODP0,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP0,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP0,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP0,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP0,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP0,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk2->Text+"ODP0,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk2->Text+"ODP0;");
  List->Items->Add("");

 if(Form3->Odp1k2->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk2->Text+"ODP1,DEV=RXODPI-"+((StrToInt(Form3->Tgk2->Text)*2)+1)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk2->Text+"ODP1,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk2->Text+"ODP1,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP1,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP1,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP1,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP1,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP1,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk2->Text+"ODP1,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk2->Text+"ODP1;");
  List->Items->Add("");
  }
  ...
  {
  List->Items->Add("@COMMENT DIP SUPERVISION");
  List->Items->Add("DTDII:DIP="+Form3->Tgk2->Text+"ODP3,DEV=RXODPI-"+((StrToInt(Form3->Tgk2->Text)*2)+3)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk2->Text+"ODP3,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk2->Text+"ODP3,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP3,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk2->Text+"ODP3,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP3,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP3,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk2->Text+"ODP3,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk2->Text+"ODP3,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk2->Text+"ODP3;");
  List->Items->Add("");
  }
}
...
//------------------------------K3 2Mbit-i-------------------------------------------//
 ...
 if(Form3->Odp0k3->Checked==true)
 {
  ...
  else
  {
   ...
   {
   List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk3->Text+",DCP="+Form3->Dcpek3Edit->Text+",DEV=RBLT2-"+Form3->Devek3Edit->Text+",RES64K;");
   List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devek3Edit->Text+";");
   List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devek3Edit->Text+";");
   List->Items->Add("");
   }

  List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk3->Text+",DCP="+Form3->Dcpk3Edit->Text+",DEV=RBLT2-"+Form3->Devk3Edit->Text+";");
  List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devk3Edit->Text+";");
  List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devk3Edit->Text+";");
  List->Items->Add("");
  }

  List->Items->Add("DTDII:DIP="+Form3->Tgk3->Text+"ODP0,DEV=RXODPI-"+(StrToInt(Form3->Tgk3->Text)*2)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk3->Text+"ODP0,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk3->Text+"ODP0,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP0,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP0,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP0,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP0,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP0,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk3->Text+"ODP0,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk3->Text+"ODP0;");
  List->Items->Add("");

 if(Form3->Odp1k3->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk3->Text+"ODP1,DEV=RXODPI-"+((StrToInt(Form3->Tgk3->Text)*2)+1)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk3->Text+"ODP1,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk3->Text+"ODP1,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP1,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP1,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP1,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP1,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP1,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk3->Text+"ODP1,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk3->Text+"ODP1;");
  List->Items->Add("");
  }

  if(Form3->Odp3k3->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk3->Text+"ODP3,DEV=RXODPI-"+((StrToInt(Form3->Tgk3->Text)*2)+3)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk3->Text+"ODP3,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk3->Text+"ODP3,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP3,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk3->Text+"ODP3,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP3,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP3,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk3->Text+"ODP3,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk3->Text+"ODP3,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk3->Text+"ODP3;");
  List->Items->Add("");
  }
}
...
//------------------------------K4 2Mbit-i-------------------------------------------//
 ...
 if(Form3->Odp0k4->Checked==true)
 {
  ...
  else
  {
   ...
   {
   List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk4->Text+",DCP="+Form3->Dcpek4Edit->Text+",DEV=RBLT2-"+Form3->Devek4Edit->Text+",RES64K;");
   List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devek4Edit->Text+";");
   List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devek4Edit->Text+";");
   List->Items->Add("");
   }

  List->Items->Add("RXAPI:MO=RXOTG-"+Form3->Tgk4->Text+",DCP="+Form3->Dcpk4Edit->Text+",DEV=RBLT2-"+Form3->Devk4Edit->Text+";");
  List->Items->Add("EXDAI:DEV=RBLT2-"+Form3->Devk4Edit->Text+";");
  List->Items->Add("BLODE:DEV=RBLT2-"+Form3->Devk4Edit->Text+";");
  List->Items->Add("");
  }

  List->Items->Add("DTDII:DIP="+Form3->Tgk4->Text+"ODP0,DEV=RXODPI-"+(StrToInt(Form3->Tgk4->Text)*2)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk4->Text+"ODP0,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk4->Text+"ODP0,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP0,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP0,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP0,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP0,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP0,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk4->Text+"ODP0,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk4->Text+"ODP0;");
  List->Items->Add("");

  if(Form3->Odp1k4->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk4->Text+"ODP1,DEV=RXODPI-"+((StrToInt(Form3->Tgk4->Text)*2)+1)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk4->Text+"ODP1,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk4->Text+"ODP1,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP1,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP1,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP1,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP1,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP1,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk4->Text+"ODP1,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk4->Text+"ODP1;");
  List->Items->Add("");
  }

  if(Form3->Odp3k4->Checked==true)
  {
  List->Items->Add("DTDII:DIP="+Form3->Tgk4->Text+"ODP3,DEV=RXODPI-"+((StrToInt(Form3->Tgk4->Text)*2)+3)+";");
  List->Items->Add("");

  List->Items->Add("DTIDC:DIP="+Form3->Tgk4->Text+"ODP3,CRC=0,QSUP=0;");
  List->Items->Add("DTFSI:DIP="+Form3->Tgk4->Text+"ODP3,FAULT=1&&4&9;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP3,FAULT=1,ACL=A1;");
  List->Items->Add("DTFSC:DIP="+Form3->Tgk4->Text+"ODP3,FAULT=2&&4&9,ACL=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP3,BFF,BFFL1=100,ACL1=A3,BFFL2=800,ACL2=A2;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP3,DF,DFL=20,ACL=A2,TI=1;");
  List->Items->Add("DTQSC:DIP="+Form3->Tgk4->Text+"ODP3,SF,SFL=100,ACL=A2,TI=1;");
  List->Items->Add("DTQSI:DIP="+Form3->Tgk4->Text+"ODP3,BFF,LH,LL,SF,DF;");
  List->Items->Add("DTBLE:DIP="+Form3->Tgk4->Text+"ODP3;");
  List->Items->Add("");
  }
...
{
//-----------------------Blok-Deblok-------------------------------------------------//
List->Items->Add("@COMMENT MO INITIATION");
...
List->Items->Add("@COMMENT CELLs SUPERVISIONS");
List->Items->Add("RLSLC:CELL="+Cell1->Text+",CHTYPE=BCCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell1->Text+",CHTYPE=SDCCH,LVA="+Rlslpsdcchc1->Text+",ACL=A2;");
List->Items->Add("RLSLC:CELL="+Cell1->Text+",CHTYPE=CBCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell1->Text+",CHTYPE=TCH,LVA="+Rlslptchc1->Text+",ACL=A1,CHRATE=FR;");
if(Icmstate->Text=="ACTIVE")
List->Items->Add("RLIMI:CELL="+Cell1->Text+";");
List->Items->Add("RLIMC:CELL="+Cell1->Text+",INTAVE="+Intave->Text+",LIMIT1="+Limit1->Text+",LIMIT2="+Limit2->Text+",LIMIT3="+Limit3->Text+",LIMIT4="+Limit4->Text+";");
List->Items->Add("RLSLI:CELL="+Cell1->Text+";");
List->Items->Add("");
Tc1=0;
 //-----------------------------------------------------------------------------------//
 //-----------------CELL2 SUPERVISIONS-----------------------------------//
if(Rlslptchc2->Text.Length()==0)
Rlslptchc2->Text=IntToStr((Tc2*7)-1);
if(Rlslpsdcchc2->Text.Length()==0)
Rlslpsdcchc2->Text=IntToStr((Tc2*8)-1);

 if(Tabc2->TabVisible==true)
{
List->Items->Add("RLSLC:CELL="+Cell2->Text+",CHTYPE=BCCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell2->Text+",CHTYPE=SDCCH,LVA="+Rlslpsdcchc2->Text+",ACL=A2;");
List->Items->Add("RLSLC:CELL="+Cell2->Text+",CHTYPE=CBCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell2->Text+",CHTYPE=TCH,LVA="+Rlslptchc2->Text+",ACL=A1,CHRATE=FR;");
if(Icmstate->Text=="ACTIVE")
List->Items->Add("RLIMI:CELL="+Cell2->Text+";");
List->Items->Add("RLIMC:CELL="+Cell2->Text+",INTAVE="+Intave->Text+",LIMIT1="+Limit1->Text+",LIMIT2="+Limit2->Text+",LIMIT3="+Limit3->Text+",LIMIT4="+Limit4->Text+";");
List->Items->Add("RLSLI:CELL="+Cell2->Text+";");
List->Items->Add("");
Tc2=0;
 }
//-----------------CELL3 SUPERVISIONS-----------------------------------//
if(Rlslptchc3->Text.Length()==0)
Rlslptchc3->Text=IntToStr((Tc3*7)-1);
if(Rlslpsdcchc3->Text.Length()==0)
Rlslpsdcchc3->Text=IntToStr((Tc3*8)-1);

if(Tabc3->TabVisible==true)
{
List->Items->Add("RLSLC:CELL="+Cell3->Text+",CHTYPE=BCCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell3->Text+",CHTYPE=SDCCH,LVA="+Rlslpsdcchc3->Text+",ACL=A2;");
List->Items->Add("RLSLC:CELL="+Cell3->Text+",CHTYPE=CBCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell3->Text+",CHTYPE=TCH,LVA="+Rlslptchc3->Text+",ACL=A1,CHRATE=FR;");
if(Icmstate->Text=="ACTIVE")
List->Items->Add("RLIMI:CELL="+Cell3->Text+";");
List->Items->Add("RLIMC:CELL="+Cell3->Text+",INTAVE="+Intave->Text+",LIMIT1="+Limit1->Text+",LIMIT2="+Limit2->Text+",LIMIT3="+Limit3->Text+",LIMIT4="+Limit4->Text+";");
List->Items->Add("RLSLI:CELL="+Cell3->Text+";");
List->Items->Add("");
Tc3=0;
 }
...
Rlslptchc4->Text=IntToStr((Tc4*7)-1);
if(Rlslpsdcchc4->Text.Length()==0)
Rlslpsdcchc4->Text=IntToStr((Tc4*8)-1);

if(Tabc4->TabVisible==true)
{
List->Items->Add("RLSLC:CELL="+Cell4->Text+",CHTYPE=BCCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell4->Text+",CHTYPE=SDCCH,LVA="+Rlslpsdcchc4->Text+",ACL=A2;");
List->Items->Add("RLSLC:CELL="+Cell4->Text+",CHTYPE=CBCH,LVA=1,ACL=A1;");
List->Items->Add("RLSLC:CELL="+Cell4->Text+",CHTYPE=TCH,LVA="+Rlslptchc4->Text+",ACL=A1,CHRATE=FR;");
if(Icmstate->Text=="ACTIVE")
List->Items->Add("RLIMI:CELL="+Cell4->Text+";");
List->Items->Add("RLIMC:CELL="+Cell4->Text+",INTAVE="+Intave->Text+",LIMIT1="+Limit1->Text+",LIMIT2="+Limit2->Text+",LIMIT3="+Limit3->Text+",LIMIT4="+Limit4->Text+";");
List->Items->Add("RLSLI:CELL="+Cell4->Text+";");
List->Items->Add("");
Tc4=0;
 }
...
void __fastcall TForm2::NeighbourpnlClick(TObject *Sender)
{
 ...
 //--------------------------------------------Cell1 qonsuluq---------------------------//
List->Items->Add("@COMMENT "+Cell1->Text+" CELL INTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
...
List->Items->Add("@COMMENT "+Cell1->Text+" CELL EXTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
if(Ncrdc1->Visible==true)
for(int t=0;t<Necellc1->Lines->Count;t++)
List->Items->Add(Necellc1->Lines->Strings[t]+" - BSC"+Bscexc1->Lines->Strings[t]);
List->Items->Add("");
...
if(Tabc2->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell2->Text+" CELL INTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
...
List->Items->Add("@COMMENT "+Cell2->Text+" CELL EXTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
if(Ncrdc2->Visible==true)
for(int t=0;t<Necellc2->Lines->Count;t++)
List->Items->Add(Necellc2->Lines->Strings[t]+" - BSC"+Bscexc2->Lines->Strings[t]);
List->Items->Add("");
}
...
if(Tabc3->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell3->Text+" CELL INTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
...
List->Items->Add("@COMMENT "+Cell3->Text+" CELL EXTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
if(Ncrdc3->Visible==true)
for(int t=0;t<Necellc3->Lines->Count;t++)
List->Items->Add(Necellc3->Lines->Strings[t]+" - BSC"+Bscexc3->Lines->Strings[t]);
List->Items->Add("");
}
...
if(Tabc4->TabVisible==true)
{
List->Items->Add("@COMMENT "+Cell4->Text+" CELL INTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
...
List->Items->Add("@COMMENT "+Cell4->Text+" CELL EXTERNAL NEIGHBOUR RELATIONS");
List->Items->Add("");
if(Ncrdc4->Visible==true)
for(int t=0;t<Necellc4->Lines->Count;t++)
List->Items->Add(Necellc4->Lines->Strings[t]+" - BSC"+Bscexc4->Lines->Strings[t]);
List->Items->Add("");
}
...
{
//--------------------------------Msc----------------------------------------//
List->Items->Add("@COMMENT CELLS ON MSC DEFINITION");
List->Items->Add("MGCEI:CELL="+Cell1->Text+",BSC=BSC"+Bscc1->Text+",CGI="+Cgic1->Text+";");
List->Items->Add("MGLNI:LOCNO="+Locnoc1->Text+";");
List->Items->Add("MGLCI:CELL="+Cell1->Text+",LOCNO="+Locnoc1->Text+";");
List->Items->Add("MGCEC:CELL="+Cell1->Text+",RO="+Ro->Text+";");
List->Items->Add("");

if(Tabc2->TabVisible==true)
{
List->Items->Add("MGCEI:CELL="+Cell2->Text+",BSC=BSC"+Bscc2->Text+",CGI="+Cgic2->Text+";");
List->Items->Add("MGLNI:LOCNO="+Locnoc2->Text+";");
List->Items->Add("MGLCI:CELL="+Cell2->Text+",LOCNO="+Locnoc2->Text+";");
List->Items->Add("MGCEC:CELL="+Cell2->Text+",RO="+Ro->Text+";");
List->Items->Add("");
}
if(Tabc3->TabVisible==true)
{
List->Items->Add("MGCEI:CELL="+Cell3->Text+",BSC=BSC"+Bscc3->Text+",CGI="+Cgic3->Text+";");
List->Items->Add("MGLNI:LOCNO="+Locnoc3->Text+";");
List->Items->Add("MGLCI:CELL="+Cell3->Text+",LOCNO="+Locnoc3->Text+";");
List->Items->Add("MGCEC:CELL="+Cell3->Text+",RO="+Ro->Text+";");
List->Items->Add("");
}

if(Tabc4->TabVisible==true)
{
List->Items->Add("MGCEI:CELL="+Cell4->Text+",BSC=BSC"+Bscc4->Text+",CGI="+Cgic4->Text+";");
List->Items->Add("MGLNI:LOCNO="+Locnoc4->Text+";");
List->Items->Add("MGLCI:CELL="+Cell4->Text+",LOCNO="+Locnoc4->Text+";");
List->Items->Add("MGCEC:CELL="+Cell4->Text+",RO="+Ro->Text+";");
List->Items->Add("");
}
...
{
//------------------------------------------CELLS ACTIVATION----------------------------------//
List->Items->Add("@COMMENT CELLS ACTIVATION");
List->Items->Add("RLSTC:CELL="+Cell1->Text+",STATE=ACTIVE;");
List->Items->Add("RLSLP:CELL="+Cell1->Text+";");
List->Items->Add("");

if(Tabc2->TabVisible==true)
{
List->Items->Add("RLSTC:CELL="+Cell2->Text+",STATE=ACTIVE;");
List->Items->Add("RLSLP:CELL="+Cell2->Text+";");
List->Items->Add("");
}

if(Tabc3->TabVisible==true)
{
List->Items->Add("RLSTC:CELL="+Cell3->Text+",STATE=ACTIVE;");
List->Items->Add("RLSLP:CELL="+Cell3->Text+";");
List->Items->Add("");
}

if(Tabc4->TabVisible==true)
{
List->Items->Add("RLSTC:CELL="+Cell4->Text+",STATE=ACTIVE;");
List->Items->Add("RLSLP:CELL="+Cell4->Text+";");
List->Items->Add("");
}
...
List->Items->Add("@GETDATE {CDATE} DD-MM-YYYY");
List->Items->Add("@GETTIME {CTIME} HH:MM");
List->Items->Add("@GETDAY {DAY} SUN MON TUE WED THU FRI SAT");
List->Items->Add("@COMMENT |===================================|");
List->Items->Add("@COMMENT | Active day and time of station is |");
List->Items->Add("@COMMENT |     {CDATE}, {DAY}, {CTIME}       |");
List->Items->Add("@COMMENT |===================================|");
List->Items->Add("@GETDATE {CDATE}");
List->Items->Add("@GETTIME {CTIME} HHMM");
List->Items->Add("@INC {CTIME} 1");
List->Items->Add("@COMMENT CELL BROADCASTING");

List->Items->Add("RLMBI:ID=50,CODE="+Codec1->Text+",GS=0,CELL="+Cell1->Text+",MODE=MML,NUMPAGES=1;");
List->Items->Add("RLMBC:ID=50,CODE="+Codec1->Text+",GS=0,PAGE=1,TEXT=\""+Brc1->Text+"\";");
List->Items->Add("RLMTI:ID=50,CODE="+Codec1->Text+",GS=0,SDATE={CDATE},STIME={CTIME},REP=10;");
List->Items->Add("");
}
...
if(Tabc2->TabVisible==true)
{
List->Items->Add("RLMBI:ID=50,CODE="+Codec2->Text+",GS=0,CELL="+Cell2->Text+",MODE=MML,NUMPAGES=1;");
List->Items->Add("RLMBC:ID=50,CODE="+Codec2->Text+",GS=0,PAGE=1,TEXT=\""+Brc2->Text+"\";");
List->Items->Add("RLMTI:ID=50,CODE="+Codec2->Text+",GS=0,SDATE={CDATE},STIME={CTIME},REP=10;");
List->Items->Add("");
}
...
if(Tabc3->TabVisible==true)
{
List->Items->Add("RLMBI:ID=50,CODE="+Codec3->Text+",GS=0,CELL="+Cell3->Text+",MODE=MML,NUMPAGES=1;");
List->Items->Add("RLMBC:ID=50,CODE="+Codec3->Text+",GS=0,PAGE=1,TEXT=\""+Brc3->Text+"\";");
List->Items->Add("RLMTI:ID=50,CODE="+Codec3->Text+",GS=0,SDATE={CDATE},STIME={CTIME},REP=10;");
List->Items->Add("");
}
...
if(Tabc4->TabVisible==true)
{
List->Items->Add("RLMBI:ID=50,CODE="+Codec4->Text+",GS=0,CELL="+Cell4->Text+",MODE=MML,NUMPAGES=1;");
List->Items->Add("RLMBC:ID=50,CODE="+Codec4->Text+",GS=0,PAGE=1,TEXT=\""+Brc4->Text+"\";");
List->Items->Add("RLMTI:ID=50,CODE="+Codec4->Text+",GS=0,SDATE={CDATE},STIME={CTIME},REP=10;");
List->Items->Add("");
}
}
//---------------------------------------------------------------------------
...
List->Items->Add("@COMMENT FINISH CHECK");
List->Items->Add("RLSLP:CELL="+Cell1->Text+";");
List->Items->Add("RLNRP:CELL="+Cell1->Text+",CELLR=ALL,NODATA;");
List->Items->Add("RLMTP:ID=ALL,CELL="+Cell1->Text+";");
List->Items->Add("");

if(Tabc2->TabVisible==true)
{
List->Items->Add("RLSLP:CELL="+Cell2->Text+";");
List->Items->Add("RLNRP:CELL="+Cell2->Text+",CELLR=ALL,NODATA;");
List->Items->Add("RLMTP:ID=ALL,CELL="+Cell2->Text+";");
List->Items->Add("");
}
...
{
List->Items->Add("RLSLP:CELL="+Cell3->Text+";");
List->Items->Add("RLNRP:CELL="+Cell3->Text+",CELLR=ALL,NODATA;");
List->Items->Add("RLMTP:ID=ALL,CELL="+Cell3->Text+";");
List->Items->Add("");
}
...
{
List->Items->Add("RLSLP:CELL="+Cell4->Text+";");
List->Items->Add("RLNRP:CELL="+Cell4->Text+",CELLR=ALL,NODATA;");
List->Items->Add("RLMTP:ID=ALL,CELL="+Cell4->Text+";");
List->Items->Add("");
}
...
{
List->Items->Add("RLBDP:CELL="+Cell1->Text+";");
List->Items->Add("RLGSP:CELL="+Cell1->Text+";");
List->Items->Add("");
}

if(Tabc3->TabVisible==false && Tabc2->TabVisible==true)
{
List->Items->Add("RLBDP:CELL="+Cell1->Text+"&"+Cell2->Text+";");
List->Items->Add("RLGSP:CELL="+Cell1->Text+"&"+Cell2->Text+";");
List->Items->Add("");
}

if(Tabc4->TabVisible==false && Tabc3->TabVisible==true)
{
List->Items->Add("RLBDP:CELL="+Cell1->Text+"&"+Cell2->Text+"&"+Cell3->Text+";");
List->Items->Add("RLGSP:CELL="+Cell1->Text+"&"+Cell2->Text+"&"+Cell3->Text+";");
List->Items->Add("");
}

if(Tabc4->TabVisible==true)
{
List->Items->Add("RLBDP:CELL="+Cell1->Text+"&"+Cell2->Text+"&"+Cell3->Text+"&"+Cell4->Text+";");
List->Items->Add("RLGSP:CELL="+Cell1->Text+"&"+Cell2->Text+"&"+Cell3->Text+"&"+Cell4->Text+";");
List->Items->Add("");
}


List->Items->Add("RXMFP:MO=RXOCF-"+Form3->Tg1->Text+";");
if(Form3->Tg2->GetTextLen()!=0)
List->Items->Add("RXMFP:MO=RXOCF-"+Form3->Tg2->Text+";");
if(Form3->Tg3->GetTextLen()!=0)
List->Items->Add("RXMFP:MO=RXOCF-"+Form3->Tg3->Text+";");
if(Form3->Tg4->GetTextLen()!=0)
List->Items->Add("RXMFP:MO=RXOCF-"+Form3->Tg4->Text+";");
List->Items->Add("");


List->Items->Add("MGCEP:CELL="+Cell1->Text+";");
List->Items->Add("MGLCP:CELL="+Cell1->Text+";");

if(Tabc2->TabVisible==true)
{
List->Items->Add("MGCEP:CELL="+Cell2->Text+";");
List->Items->Add("MGLCP:CELL="+Cell2->Text+";");
}
if(Tabc3->TabVisible==true)
{
List->Items->Add("MGCEP:CELL="+Cell3->Text+";");
List->Items->Add("MGLCP:CELL="+Cell3->Text+";");
}
if(Tabc4->TabVisible==true)
{
List->Items->Add("MGCEP:CELL="+Cell4->Text+";");
List->Items->Add("MGLCP:CELL="+Cell4->Text+";");
}
List->Items->Add("");
...
void __fastcall TForm2::FinishcheckpnlClick(TObject *Sender)
{
for(int i=0;i<List->Items->Count;i++)
{
   int Bos=List->Items->Strings[i].Pos("=,");
   int Bos2=List->Items->Strings[i].Pos("=;");
   if(Bos || Bos2)
   {
        for(int k=0;k<List->Items->Strings[i].Length()+5;k++){
        if(int Bos=List->Items->Strings[i].Pos("=,")){
        List->Items->Strings[i]=List->Items->Strings[i].SubString(0,Bos-2)+List->Items->Strings[i].SubString(Bos,List->Items->Strings[i].Length());
        if(int a=List->Items->Strings[i].Pos(",=,"))
        List->Items->Strings[i]=List->Items->Strings[i].SubString(0,a)+List->Items->Strings[i].SubString(a+3,List->Items->Strings[i].Length());
        }
        if(int Bos2=List->Items->Strings[i].Pos("=;")){
        List->Items->Strings[i]=List->Items->Strings[i].SubString(0,Bos2-2)+List->Items->Strings[i].SubString(Bos2,List->Items->Strings[i].Length());
        if(int a=List->Items->Strings[i].Pos(",=;"))
        List->Items->Strings[i]=List->Items->Strings[i].SubString(0,a-1)+List->Items->Strings[i].SubString(List->Items->Strings[i].Length(),1);
        }
        }
        if(List->Items->Strings[i].Length()!=18)
        List->Checked[i]=true;
   }
  else
  List->Checked[i]=true;
...
void __fastcall TForm2::Cspsallocc1Change(TObject *Sender)
{
if(Tabc2->TabVisible==true)
 Cspsallocc2->Text=Cspsallocc1->Text;

  if(Tabc3->TabVisible==true)
  Cspsallocc3->Text=Cspsallocc1->Text;

  if(Tabc4->TabVisible==true)
 Cspsallocc4->Text=Cspsallocc1->Text;
}
//---------------------------------------------------------------------------
...
void __fastcall TForm2::Cic3Change(TObject *Sender)
{
Cgic3->Text="400-01-"+Lacc3->Text+"-"+Cic3->Text;        
}
//---------------------------------------------------------------------------

void __fastcall TForm2::Cic4Change(TObject *Sender)
{
Cgic4->Text="400-01-"+Lacc4->Text+"-"+Cic4->Text;        
}
//---------------------------------------------------------------------------

void __fastcall TForm2::Locnoc1Change(TObject *Sender)
{
if(Tabc2->TabVisible==true)
{
int Size = Locnoc1->GetTextLen(); //Get length of string in Edit1

  Size++;                      //Add room for null character

  char *Buffer = new char[Size];  //Creates Buffer dynamic variable
   char *Buffert = new char[Size];
  Locnoc1->GetTextBuf(Buffer,Size);
  Locnoc1->GetTextBuf(Buffert,Size-1); //Puts Edit1->Text into Buffer
  String f =Buffert;
  Locnoc2->Text=f+(StrToInt(Buffer[Locnoc1->GetTextLen()-1])+1);

  if(Tabc3->TabVisible==true)
  Locnoc3->Text=f+(StrToInt(Buffer[Locnoc1->GetTextLen()-1])+2);


  if(Tabc4->TabVisible==true)
  Locnoc4->Text=f+(StrToInt(Buffer[Locnoc1->GetTextLen()-1])+3);
...
void __fastcall TForm2::Neighbour3gpnlClick(TObject *Sender)
{
/*
  if(N3gc1Memo->Lines->Count!=0) {
        List->Items->Add("@3G NEIGHBOUR RELATIONS");
        List->Items->Add("@2G SIDE");
        for(int i=0;i<N3gc1Memo->Lines->Count;i++){
        int k=ReportMemo->Text.Pos("RLDEI:CELL="+N3gc1Memo->Lines->Strings[i]+",EXT,UTRAN;");
        int m=ReportMemo->Text.Pos("RLDEC:CELL="+N3gc1Memo->Lines->Strings[i]+",UTRANID=400-01-"+Lac->Text+"-"+CidMemo->Lines->Strings[i]+"-"+Rncid->Text+",FDDARFCN="+UarMemo->Lines->Strings[i]+",SCRCODE="+ScrMemo->Lines->Strings[i]+",MRSL="+Mrsl->Text+";");
        if(!k)
