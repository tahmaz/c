...
if(LoaddefCheckBox->Checked==true){
 ...
 if(Fhop->ItemIndex==1){
 Bufferf3->Clear();
 if (FileExists("Bin\\SY_GSM1800.trg"))
 Bufferf3->Lines->LoadFromFile("Bin\\SY_GSM1800.trg");
 Form2->LoadcellClick(Form2->Loadcell);}

 if(Fhop->ItemIndex==0){
 Bufferf3->Clear();
 if (FileExists("Bin\\BB_GSM1800.trg"))
...
Form2->Tchch0c1->Text="";
Form2->Tchch0c1->Font->Color=clWindowText;
...
if(Fhop->ItemIndex==1)
{
Form2->Tchch0c1->Text="BCCH";
Form2->Tchch0c1->Font->Color=cl3DLight;
...
String RLHPPC1,RLCLPC1,RLGSPC1,RLAPPC1,RLGAPC1;
...
Bir:{
if (FileExists("Images\\sola.bmp"))
Pbodp01k1->Glyph->LoadFromFile("Images\\sola.bmp");
Ppodp01k1->Show();
goto son;}
Iki:{
if (FileExists("Images\\saga.bmp"))
 ...
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
  {
    ...
    Swverk2->ItemIndex=1;
    else if(SWVERACTS=="B4407R020J")
    Swverk2->ItemIndex=2;
    else
    Swverk2->Text=SWVERACTS;
    }
...
if(Komanda=="RLDEP:CELL="+Form6->Cell1->Text+";")
 {
    for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
    {
        ...
        if (int IRC= Form6->Memo1->Lines->Strings[I].Pos("IRC"))
        {
        String  IRCS=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(IRC,4));
        if(IRCS=="ON")
        Form2->Irc->ItemIndex=0;
        else
        Form2->Irc->ItemIndex=1;
        }
       ...
       Form2->Sdcchchgr0c1->Text=Trim(Form6->Memo1->Lines->Strings[I].SubString(SDCCH,3));
         ...
         Memo2->Lines->Clear();
          ...
          y++;
            ...
            {
             if(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4))!=Form2->Bcchnoc1->Text)
...
if(Komanda=="RLLDP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        ...
        if (int RLINKUPAFR=Form6->Memo1->Lines->Strings[I].Pos("RLINKUPAFR"))
        Form2->Rlinkupafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(RLINKUPAFR,4));
...
if(Komanda=="RLLCP:CELL="+Form6->Cell1->Text+";")
{
 ...
 {      int k=1;
        ...
        Form2->Clsstate->ItemIndex=1;
        else
        Form2->Clsstate->ItemIndex=0;}

        if (int CLSLEVEL=Form6->Memo1->Lines->Strings[I].Pos("CLSLEVEL"))
        Form2->Clslevel->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CLSLEVEL,4));

        if (int CLSACC=Form6->Memo1->Lines->Strings[I].Pos("CLSACC"))
        Form2->Clsacc->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CLSACC,4));
        ...
        if(HOCLSACCS=="OFF")
        Form2->Hoclsacc->ItemIndex=1;
        else
        Form2->Hoclsacc->ItemIndex=0;}

        if (int RHYST=Form6->Memo1->Lines->Strings[I].Pos("RHYST"))
        Form2->Rhyst->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(RHYST,5));

        if (int CLSRAMP=Form6->Memo1->Lines->Strings[I].Pos("CLSRAMP"))
        Form2->Clsramp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CLSRAMP,4));
...
if(Komanda=="RLSSP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        ...
        if (int CRHC1=Form6->Memo1->Lines->Strings[I].Pos("CRHC1"))
        Form2->Crhc1->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CRHC1,4));
        ...
        if (int RLINKTAFR=Form6->Memo1->Lines->Strings[I].Pos("RLINKTAFR"))
        Form2->Rlinktafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(RLINKTAFR,4));
...
if(Komanda=="RLHPP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        int k=1;
        ...
        if (int CHAP=Form6->Memo1->Lines->Strings[I].Pos("CHAP"))
        Form2->Chapc1->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CHAP,3));
...
if(Komanda=="RLCLP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        int k=1;
        ...
        if (int CSPSALLOC=Form6->Memo1->Lines->Strings[I].Pos("CSPSALLOC "))
        Form2->Cspsallocc1->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(CSPSALLOC,14));
...
if(Komanda=="RLSBP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        ...
        if (int ACC=Form6->Memo1->Lines->Strings[I].Pos("ACC "))
        Form2->Acc->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(ACC,6));
...
if(Komanda=="RLIHP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        ...
        if (int QOFFSETULP=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETULP "))
        Form2->Qoffsetulp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETULP,3));
        ...
        if (int QOFFSETDLP=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETDLP "))
        Form2->Qoffsetdlp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETDLP,3));

        if (int SSOFFSETULN=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETULN "))
        Form2->Ssoffsetuln->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETULN,3));
        ...
        if (int SSOFFSETDLN=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETDLN "))
        Form2->Ssoffsetdln->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETDLN,3));
        ...
        if (int SSOFFSETULAFRP=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETULAFRP "))
        Form2->Ssoffsetulafrp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETULAFRP,3));

        if (int QOFFSETULAFRP=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETULAFRP "))
        Form2->Qoffsetulafrp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETULAFRP,3));

        if (int SSOFFSETDLAFRP=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETDLAFRP "))
        Form2->Ssoffsetdlafrp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETDLAFRP,3));

        if (int QOFFSETDLAFRP=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETDLAFRP "))
        Form2->Qoffsetdlafrp->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETDLAFRP,3));

        if (int SSOFFSETULAFRN=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETULAFRN "))
        Form2->Ssoffsetulafrn->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETULAFRN,3));

        if (int QOFFSETULAFRN=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETULAFRN "))
        Form2->Qoffsetulafrn->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETULAFRN,4));

        if (int SSOFFSETDLAFRN=Form6->Memo1->Lines->Strings[I].Pos("SSOFFSETDLAFRN "))
        Form2->Ssoffsetdlafrn->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSOFFSETDLAFRN,3));

        if (int QOFFSETDLAFRN=Form6->Memo1->Lines->Strings[I].Pos("QOFFSETDLAFRN "))
        Form2->Qoffsetdlafrn->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QOFFSETDLAFRN,4));
...
if(Komanda=="RLGSP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        int k=1;
        ...
        if (int FPDCH=Form6->Memo1->Lines->Strings[I].Pos("FPDCH "))
        Form2->Fpdch->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(FPDCH,3));

        if (int GAMMA=Form6->Memo1->Lines->Strings[I].Pos("GAMMA"))
        Form2->Gamma->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(GAMMA,3));

        if (int LA= Form6->Memo1->Lines->Strings[I].Pos("LA ")){
        String  LAS=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(LA,4));
        if(LAS=="OFF")
        Form2->La->ItemIndex=1;
        else
        Form2->La->ItemIndex=0;}
...
if(Komanda=="RLAPP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        int k=1;
        ...
        if (int AMRPCSTATE= Form6->Memo1->Lines->Strings[I].Pos("AMRPCSTATE ")){
        String  AMRPCSTATES=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(AMRPCSTATE,7));
        if(AMRPCSTATES=="ACTIVE")
        Form2->Amrpcstate->ItemIndex=0;
        else
        Form2->Amrpcstate->ItemIndex=1;}

        if (int SSDESDLAFR=Form6->Memo1->Lines->Strings[I].Pos("SSDESDLAFR "))
        Form2->Ssdesdlafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSDESDLAFR,3));

        if (int QDESDLAFR=Form6->Memo1->Lines->Strings[I].Pos("QDESDLAFR "))
        Form2->Qdesdlafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QDESDLAFR,3));

        if (int SSDESULAFR=Form6->Memo1->Lines->Strings[I].Pos("SSDESULAFR "))
        Form2->Ssdesulafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSDESULAFR,3));

        if (int QDESULAFR=Form6->Memo1->Lines->Strings[I].Pos("QDESULAFR"))
        Form2->Qdesulafr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QDESULAFR,3));

        if (int SSDESDLAHR=Form6->Memo1->Lines->Strings[I].Pos("SSDESDLAHR "))
        Form2->Ssdesdlahr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSDESDLAHR,3));

        if (int QDESDLAHR=Form6->Memo1->Lines->Strings[I].Pos("QDESDLAHR "))
        Form2->Qdesdlahr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QDESDLAHR,3));

        if (int SSDESULAHR=Form6->Memo1->Lines->Strings[I].Pos("SSDESULAHR "))
        Form2->Ssdesulahr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SSDESULAHR,3));

        if (int QDESULAHR=Form6->Memo1->Lines->Strings[I].Pos("QDESULAHR"))
        Form2->Qdesulahr->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(QDESULAHR,3));
...
if(Komanda=="RLGAP:CELL="+Form6->Cell1->Text+";")
{
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
 {
        int k=1;
        ...
        if (int SAS=Form6->Memo1->Lines->Strings[I].Pos("SAS "))
        Form2->Sas->Text=Trim(Form6->Memo1->Lines->Strings[I+k].SubString(SAS,8));
...
if(Komanda=="NOVBETI" && Giris==true && RLSSPC1!="OK")
 ...
 Form3->IdTelnet1->WriteLn(Komanda);
  ...
  //---------------------------------------RLHPPC1----------------------------------------//
if(Komanda=="NOVBETI" && Giris==true && RLHPPC1!="OK")
  {
  Form6->Memo1->Clear();
  Komanda="RLHPP:CELL="+Form6->Cell1->Text+";";
 Form3->IdTelnet1->WriteLn(Komanda);
  goto son;
  }
  //---------------------------------------RLCLPC1----------------------------------------//
if(Komanda=="NOVBETI" && Giris==true && RLCLPC1!="OK")
  {
  Form6->Memo1->Clear();
  Komanda="RLCLP:CELL="+Form6->Cell1->Text+";";
 Form3->IdTelnet1->WriteLn(Komanda);
  goto son;
  }
//---------------------------------------RLSBPC1----------------------------------------//
...
if(Komanda=="NOVBETI" && Giris==true && RLCDPC1!="OK")
 ...
 Form3->IdTelnet1->WriteLn(Komanda);
  ...
  //---------------------------------------RLGSPC1----------------------------------------//
if(Komanda=="NOVBETI" && Giris==true && RLGSPC1!="OK")
  {
  Form6->Memo1->Clear();
  Komanda="RLGSP:CELL="+Form6->Cell1->Text+";";
 Form3->IdTelnet1->WriteLn(Komanda);
  goto son;
  }
  //---------------------------------------RLAPPC1----------------------------------------//
if(Komanda=="NOVBETI" && Giris==true && RLAPPC1!="OK")
  {
  Form6->Memo1->Clear();
  Komanda="RLAPP:CELL="+Form6->Cell1->Text+";";
 Form3->IdTelnet1->WriteLn(Komanda);
  goto son;
  }
  //---------------------------------------RLGAPC1----------------------------------------//
if(Komanda=="NOVBETI" && Giris==true && RLGAPC1!="OK")
  {
  Form6->Memo1->Clear();
  Komanda="RLGAP:CELL="+Form6->Cell1->Text+";";
 Form3->IdTelnet1->WriteLn(Komanda);
  goto son;
  }
//---------------------------------------RLIMPC1----------------------------------------//
       ...
       Form2->Sdcchchgr0c2->Text=Trim(Form6->Memo1->Lines->Strings[I].SubString(SDCCH,3));
         ...
         Memo2->Lines->Clear();
          ...
          y++;
            ...
            Trim(Form6->Memo1->Lines->Strings[y+d].SubString(CHGR,5))=="1")
            {
            if(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4))!=Form2->Bcchnoc2->Text)
             Memo1->Lines->Add(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4)));
             Form3->Memo1DblClick(Memo1);
       ...
       Form2->Sdcchchgr0c3->Text=Trim(Form6->Memo1->Lines->Strings[I].SubString(SDCCH,3));
         ...
         Memo2->Lines->Clear();
          ...
          y++;
            ...
            Trim(Form6->Memo1->Lines->Strings[y+d].SubString(CHGR,5))=="1")
            {
            if(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4))!=Form2->Bcchnoc3->Text)
             Memo1->Lines->Add(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4)));
             Form3->Memo1DblClick(Memo1);
       ...
       Form2->Sdcchchgr0c4->Text=Trim(Form6->Memo1->Lines->Strings[I].SubString(SDCCH,3));
         ...
         Memo2->Lines->Clear();
          ...
          y++;
            ...
            Trim(Form6->Memo1->Lines->Strings[y+d].SubString(CHGR,5))=="1")
            {
            if(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4))!=Form2->Bcchnoc4->Text)
             Memo1->Lines->Add(Trim(Form6->Memo1->Lines->Strings[y].SubString(DCHNO,4)));
             Form3->Memo1DblClick(Memo1);
...
Form2->CheckpnlClick(Form2->Checkpnl);
 ...
 Form2->FinishcheckpnlClick(Form2->Finishcheckpnl);
 Form2->Test="";
 
 Form1->Memo1->Clear();
 for(int i=0;i<Form2->List->Items->Count;i++)
 if(Form2->List->Checked[i])
 Form1->Memo1->Lines->Add(Form2->List->Items->Strings[i]);
 }
 ...
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
  {
    ...
    if (int FAULT= Form6->Memo1->Lines->Strings[I].Pos("NOT ACCEPTED"))
    {
    Form2->Nbcchc1->Lines->Add("");
    Form2->Bscinc1->Lines->Add("");
    Form2->Bscinc1->Lines->Strings[SAY]=Trim(Form6->Memo1->Lines->Strings[I].SubString(FAULT,30));
    }
 ...
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
  {
    ...
    Form2->Bscinc2->Lines->Strings[SAY]=Trim(Form6->Memo1->Lines->Strings[I].SubString(FAULT,30));
    }
 ...
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
  {
    ...
    Form2->Bscinc3->Lines->Strings[SAY]=Trim(Form6->Memo1->Lines->Strings[I].SubString(FAULT,30));
    }
 ...
 for (int I = 0; I < Form6->Memo1->Lines->Count; I++)
  {
    ...
    Form2->Bscinc4->Lines->Strings[SAY]=Trim(Form6->Memo1->Lines->Strings[I].SubString(FAULT,30));
    }
...
void __fastcall TForm3::LoaddefCheckBoxClick(TObject *Sender)
{
